                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="mb-3">
                            ...
                            <select required disabled name="country_code" class="form-control">
                              <option <?php if($userDetails[0]->country_code=="+966") echo 'selected'; ?> value="<?php echo PHONE_CODE ?>"><?php echo PHONE_CODE ?></option>
                            </select>
