      ...
      <div style="width:100%;margin:auto">
        <div style="margin:auto;width:500px">
          <div style="padding:5px;margin:auto;width:95%;">
            ...
            <p style="font-size:18px">Dear team,<br> <?php echo($infos["name"]) ?> wants to be contacted for getting a quote on building PC Gamer</p>
            <?php else: ?>
            <p style="font-size:18px">Dear team,<br> <?php echo($infos["name"]) ?> has sent a quote query for building a customized Gamer PC, the information are below</p>
            <?php endif; ?>
          </div>
            ...
            <?php
              $i=0;
               foreach ($infos as $key => $value) {
                    if($value !== "" && key_exists($key,$biblio)){         
                ?>
              <tr style="background-color:rgb(236, 236, 236);color:black">
