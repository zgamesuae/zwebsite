...
<?php
    ...
    $order_has_dc = $orderModel->cart_has_digital_codes($user_id);
    // var_dump($cart);die();
?>
                                    ...
                                    <div class="col-12">
                                        <div class=" justify-content-center row">
                                            <div class="col-12 row p-0 my-2">
                                                ...
                                                <!-- CASH ON DELIVERY -->
                                                <?php
                                                if ($pre_order_enabled == "No" && !$order_has_dc){
                                                ?>
                                                ...
                                                <div class="col-12 row px-0 py-2 m-0 my-1">
                                                    <div class="col-auto p-2 mx-2 border payment-method d-flex a-a-center">
                                                        <label class="checkbox light-green d-flex m-0" for="installation-checkbox2" style="cursor: pointer">
                                                            <input hidden id="installation-checkbox2" type="radio" required class="mr-2" name="payment_method" value="Cash on delivery">
