<div class="ws-bundle-prop-element p-2 col-4 col-xl-3" style="position: relative;" data-price="<?php echo $price ?>" data-product="<?php echo $product->sku ?>">
    ...
    <div class="ws-prop-img d-flex justify-content-center mb-3 col-12 p-0" <?php if($product->available_stock <= 0) echo "style='mix-blend-mode: luminosity;'"; ?>>
        <img src="<?php echo base_url() ?>/assets/uploads/<?php echo $GLOBALS["productModel"]->get_product_image($product->product_id , false , false) ?>" width="auto" alt="" style="max-height: 100px">
    </div>
    <div class="ws-bundle-infos d-flex flex-column justify-content-center text-center">
        <b><span class="currency"><?php echo CURRENCY ?></span> <span><?php echo $price ?></span></b>
