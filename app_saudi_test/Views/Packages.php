             ...
             $total=$total+($v->price-($v->dp*$v->price)/100);
                    ...
                    <div class="pricing-card">
                       ...
                       if($v->dp > 0 ){
                           ...
                           <div class="card-subtitle">
                              <span><?php echo number_format($v->price) ;?><?php echo CURRENCY ?></span>
                          </div>
                          <p class="offer-price card-text"><?php echo number_format($v->price - ($v->dp*$v->price)/100);?><span><?php echo CURRENCY ?></span></p>
                      <?php } else {
                      ?> <div class="card-subtitle">
                      </div>
              ...
              <div class="d-none products_price text-small text-primary font-weight-bold">
               ...
               if($v->dp > 0 ){
                   ...
                   <span class="curreny"><?php echo CURRENCY ?></span>
                   <del class="text-gray"><?php echo number_format($v->price);?> <?php echo CURRENCY ?></del>
               <?php } else {
                  ?>
...
<div class="col-md-4">
    <div class="bg-white shadow-sm products_package_left_s">
        <h4 class="text-capitalize"><strong><?php echo  $vv->title;?></strong></h4>
        <ul>
            <li>Original Price <span> <?php echo $opric;?> <?php echo CURRENCY ?></span></li>
            <li>Discount <span>- <?php echo $dis;?> <?php echo CURRENCY ?></span></li>
            <li>Total <span> <?php echo $total;?> <?php echo CURRENCY ?></span></li>
        </ul>
        <h2>Total : <?php echo CURRENCY ?> <?php echo $total;?> </h2>
