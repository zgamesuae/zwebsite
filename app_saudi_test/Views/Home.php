...
$cats = [
    ...
    [
        ...
        "link" => base_url() . "/product-list/kgaming-accessories",
    ...
    [
        ...
        "ara_title" => "المقتنيات",
        "link" => base_url() . "/product-list?type=48,41",
...
<div class="container-fluid home-sec">
    <div class="row col-md-12 col-sm-12 col-lg-10 home_h_banner d-flex-row">
        <a href="<?php base_url() ?>/playstation/consoles?show-offer=yes"><img alt="Jumbo PS5 Eid offer" class="desktop_img" src="<?php echo base_url()?>/assets/uploads/zgames_horz_jumbo_psg_eidoffer_2023.gif" alt=""></a>
        <a href="<?php base_url() ?>/playstation/consoles?show-offer=yes"><img alt="Jumbo PS5 Eid offer" class="mobile_img" src="<?php echo base_url()?>/assets/uploads/zgames_horz_jumbo_psg_eidoffer_2023_mob.gif" alt=""></a>
    </div>
</div>
<?php } ?>
<!--Jumbo PS5 Eid offer-->
...
<div class="container-fluid home-sec">
    <div class="row col-md-12 col-sm-12 col-lg-10 home_h_banner d-flex-row">
        <a href="<?php base_url() ?>/ramadan-deals"><img alt="ramadan-deals" class="d-none d-lg-block" src="<?php echo base_url()?>/assets/others/sa-032024-ramadan-offers-home-hz-banner.jpg" alt=""></a>
        <a href="<?php base_url() ?>/ramadan-deals"><img alt="ramadan-deals" class="d-sm-block d-lg-none" src="<?php echo base_url()?>/assets/others/sa-032024-ramadan-offers-home-hz-banner-mobile.jpg" alt=""></a>
    </div>
</div>
<?php } ?>
<!--Handheld Gaming banners-->
    ...
    <div class="row j-c-center">
        <div class="col-12 col-xl-10">
           <div class="sec_title text-dark ">
               <h2 class="text-white"><?php echo lg_get_text("lg_337") ?></h2>
           </div>
        </div>
...
if($spiderman_section){
    ...
    "section_division" => [
        ["img"=> base_url()."/assets/others/carrousel_cat_spiderman_figurines.jpg" , "link" => base_url()."/product-list?type=41&keyword=spider"],
        ["img"=> base_url()."/assets/others/carrousel_cat_spiderman_vgames.jpg" , "link" => base_url()."/product-list?type=5&keyword=spider"],
        ["img"=> base_url()."/assets/others/carrousel_cat_spiderman_drinkware.jpg" , "link" => base_url()."/product-list?type=49,50&keyword=spider"],
...
<?php 
if(isset($new_in_pc_gaming) && false){
    $car_params = [
        "section_background" => [],
        "section_division" => [],
        "no_bg" => false,
...
if($pc_parts){
    $car_params = [
        "section_background" => [
            "desktop" => base_url()."/assets/others/sa-pc-section-home-cover-desktop.jpg",
            "mobile" => base_url()."/assets/others/sa-pc-section-home-cover-mobile.jpg",
        ],
        "section_division" => [
            ["img"=> base_url()."/assets/others/carousel-cat-pc-parts-cpu.png" , "link" => base_url()."/gaming-accessories/processor"],
            ["img"=> base_url()."/assets/others/carousel-cat-pc-parts-gpu.png" , "link" => base_url()."/gaming-accessories/graphics-card"],
            ["img"=> base_url()."/assets/others/carousel-cat-pc-parts-psupply.png" , "link" => base_url()."/gaming-accessories/power-supply"],
            ["img"=> base_url()."/assets/others/carousel-cat-pc-parts-rams.png" , "link" => base_url()."/gaming-accessories/ram"],
        ],
        "no_bg" => false,
        "bts_font" => false
    ];
...
if($new_gaming_merchandize){
    ...
    echo view("Product_carousel" , array_merge((array)$new_gaming_merchandize , $car_params)) ;
}
...
if($more_games){
    ...
    echo view("Product_carousel" , array_merge((array)$more_games , ["no_bg" => false , "bts_font" => false]));
}

if($more_accessories){

    echo view("Product_carousel" , array_merge((array)$more_accessories , ["no_bg" => false , "bts_font" => false])) ;
}
...
<div class="container-fluid home-sec pt-4 pb-4">
    <div class="row j-c-center">
        <div class="text-justify col-12 col-xl-10" style="color: rgb(247, 247, 247)">
            <p>
