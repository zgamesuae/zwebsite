<?php 
    ...
    $cart_count_req = "select * from cart inner join products on cart.product_id=products.product_id where user_id='".$user_id."' and products.status='Active'";
...
<head>
    ...
    <title><?php  if(@$prod){ echo "Shop $prod->name with ".$settings[0]->business_name." in KSA - Al Riyadh,Jeddah,Tabuk,Jazan$sku";}else{ echo ucwords($settings[0]->business_name);}?></title>
    ...
    <script>
        ...
        fbq('init', '1865952190439260');
        fbq('track', 'PageView');
    </script>
    <!-- Facebook Pixel Code saudi -->
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1865952190439260&ev=PageView&noscript=1" /></noscript>
    <?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/6362536adaff0e1306d54c2d/1hfes8fhq';
        s1.charset='UTF-8';
    ...
    <!-- Google Tag Manager -->
        <script>
            ...
            })(window,document,'script','dataLayer','GTM-PGC5V3F');
        </script>
    ...
    <style>
        /* Yahia custom css */
            ...
            .promotion_sticker.get_right_sticker{
                right: 10px;
                max-width: 45px;
                filter: drop-shadow(0px 1px 2px rgba(0, 0, 0, 0.644));
            }
            /* Promotion sticker */
    ...
    <?php endif; ?>
    <meta name="google-site-verification" content="spHZhA0TASSnXGdOjgRPUiKqWLGFYS8R4Y_U26kXDYg" />
</head>
...
<body class="page-<?php echo @$uri1;?>">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PGC5V3F" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
