...
<footer class="container-fluid bg-light pt-3">
    <div class="container">
        <div class="row <?php if(get_cookie("language") == "AR") echo 'text-right'; ?>" <?php if(get_cookie("language") == "AR") echo 'dir="rtl"' ?>>
            ...
            <div class="col-md-4 col-sm-6 mt-4">
                ...
                <?php echo view("newsletter/Subscribe_nl_bar.php"); ?>
            </div>
    ...
    <div class="header_bottom">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="footer_payment_logo row m-0 j-c-center">
                    ...
                    <div class="payment_logo col-auto m-0 my-1 p-0">
                        <img class="mx-3" src="<?php echo base_url() ?>/assets/others/apple_pay.png" alt="Mada Card">
                    </div>
        ...
        <div class="copyright_footer">
            ...
            <p style="font-size: .8rem" class="py-2">
                <?php echo lg_get_text("lg_376")?> 311497332600003, <?php echo lg_get_text("lg_377")?> 1010824122, <?php echo lg_get_text("lg_378")?> 0000054964
            </p>
...
<script type="text/javascript" src="<?php echo base_url(); ?>/assets/js/offers/offers.js"></script>
