    ...
    switch ($seg) {
        case 'order-success':
            ...
            if($order && sizeof($order) > 0):
                $products = $orderModel->get_order_products($order_id);
                ...
                $total_quantity = $orderModel->order_total_quantity($order_id);
                $value = $order["total"];
                ...
                <script>
                    ...
                    ttq.identify({
                        ...
                        phone_number: '<?php echo PHONE_CODE.$order["phone"] ?>',
                    })
        ...
        ?>
            <script>
                ttq.identify({
                    email: '<?php echo $userModel->get_user_email($user_id) ?>',
                    phone_number: '<?php echo PHONE_CODE.$userModel->get_user_phone($user_id) ?>',
                }) 
...
?>
    ...
    <script>
        window.c_email = "<?php echo $userModel->get_user_email($user_id) ?>";
    </script>
