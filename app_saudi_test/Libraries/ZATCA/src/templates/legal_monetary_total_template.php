...
return <<<XML
    ...
    <cac:LegalMonetaryTotal>
        ...
        <cbc:AllowanceTotalAmount currencyID="SAR">_AllowanceTotalAmount</cbc:AllowanceTotalAmount>
        <cbc:ChargeTotalAmount currencyID="SAR">_ChargeTotalAmount</cbc:ChargeTotalAmount>
        <cbc:PrepaidAmount currencyID="SAR">_PrepaidAmount</cbc:PrepaidAmount>
