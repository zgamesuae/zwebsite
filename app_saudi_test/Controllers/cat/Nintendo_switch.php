...
class Nintendo_switch extends \App\Controllers\BaseController{
    ...
    public function index(){
        ...
        // HEADSETS SECTION
        $headsets_filter = [
            "master_category" => "headset-16376528716368",
            "sort" => "Newest", // Newest, Oldest, Highest, Lowest
            "page" => 1,
            "limit" => 20,
        ];
        if($products = $this->productModel->product_filter_query($headsets_filter))
		$data["headsets"] = array("list"=>$products["product"],"title"=>strtoupper(lg_get_text("lg_94")),"link"=> base_url()."/nintendo-switch/accessories/headsets");
        
        
        // CONTROLLERS SECTION
        $controllers_filter = [
            "master_category" => "controllers-1641137726",
            // "type" => ["27"],
            "sort" => "Newest", // Newest, Oldest, Highest, Lowest
            "page" => 1,
            "limit" => 20,
		...
		$data["controllers"] = array("list"=>$products["product"],"title"=>strtoupper(lg_get_text("lg_95")),"link"=> base_url()."/nintendo-switch/accessories/controllers");
