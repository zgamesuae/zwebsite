...
class AdminGroup extends \App\Controllers\BaseController
{
    public function index()
    {
        ...
        $crud->setTable("admin_group");
        $crud->setSubject("admin_group slider", "admin_group slider");

        $crud->fieldType("group_id", "hidden");
        $crud->callbackBeforeInsert(function ($stateParameters) {
            $stateParameters->data["group_id"] =
                url_title($stateParameters->data["name"], "-", true) .
                "-" .
                time();
