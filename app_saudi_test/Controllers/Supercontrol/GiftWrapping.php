...
class GiftWrapping extends \App\Controllers\BaseController
{
    public function index()
    {
        ...
        $crud->setTable("gift_wrapping");
        $crud->setSubject("Gift Wrapping", "Gift Wrapping");
        ...
        $crud->requiredFields(["image", "status", "title"]);
