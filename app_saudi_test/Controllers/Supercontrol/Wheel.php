...
class Wheel extends \App\Controllers\BaseController
{
  ...
  protected $brandModel;
    ...
    public function index()
    {
        ...
        $crud->setTable('user_spined_wheel');
        $crud->setRelation('user_id', 'users', 'name');
        $crud->displayAs('user_id','name');

        $crud->setSubject('Spin Wheel', 'Spin Wheel');
        //   Access Start
