...
class Charges extends \App\Controllers\BaseController
{
    public function index()
    {
        ...
        $crud->setTable("charges");
        $crud->setSubject("Charges", "Charges");
        
        //  $crud->setFieldUpload('image', 'assets/uploads', base_url() . '/assets/uploads');
        $crud->unsetFields(["created_at", "updated_at"]);
        $crud->requiredFields(["title", "value", "status" , "category" , "arabic_title"]);

        $crud->setRelation("city", "city", "title");
        $crud->setRelation("category", "charge_categories", "title");
