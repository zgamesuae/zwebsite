...
if(true){
  ...
  foreach($urls as $key => $value){
    if($value !== "playstation" && $value !== "xbox" && $value !== "nintendo-switch" && $value !== "gaming-pc" && $value !== "digital-codes-and-gift-cards"){
      $routes->add($value,'Page::productList/'.$key);
    }
    
    else{
      switch (true) {
        case (in_array($value , ["nintendo-switch" , "gaming-pc" , "digital-codes-and-gift-cards"])):
          # code...
