...
class TabbyModel extends Model{
    ...
    public function structure_data($cart , $cart_charges , $total_cart , $cart_coupon_discount , $user_address , $user_id , $scoring = true){
        ...
        $session_body_request = [
            "payment" => [
                "amount" => (string)($total_cart - $cart_coupon_discount + $cart_charges),
                "currency" => CURRENCY,
                "buyer" => [
                ...
                "order" => [
                    "shipping_amount" => (string)($cart_charges),
                    "discount_amount" => $cart_coupon_discount,
