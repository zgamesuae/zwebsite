...
class Products extends \App\Controllers\BaseController {
    ...
    public function bulkUpload(){
        ...
        $recognized_field = array(
            ...
            "arabic_features" =>                        array("required_fo_update"=>false , "required_for_creation"=>true),
    ...
    public function index() {
        ...
        $crud->columns(['sku' , 'precedence' , 'name', 'type' , 'brand' , 'product_nature' , 'images' , 'price' , 'set_as_new' , 'available_stock' , 'category', 'description' , "pre_order_enabled" ,  'google_category' , 'status' ,  'created_at']);
