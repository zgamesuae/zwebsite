    ...
    public function update_variable_price(){
        ...
        if(sizeof($_GET) > 0){
            ...
            if($product && $product !== null ){
                ...
                if($this->productModel->get_discounted_percentage($product->product_id) > 0){
                    $data["offer_price"] = round(bcdiv($product->price - ($product->discount_percentage*$product->price)/100, 1, 2));
                }
