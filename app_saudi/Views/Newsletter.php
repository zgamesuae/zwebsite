...
* {
 ...
 <div style="height:auto; width:630px; background-color: #03223e; margin:auto"> 
                ...
                <td align="center">
                    ...
                    <table align="center" style="background-color:#011424; width:100%; max-width:650px; height:auto; column-gap: 10px; border-collapse:separate; border-spacing:8px; border-radius:3px; margin-top: 20px;">
                        <thead style="text-align:center; color:white ">
                            ...
                            <?php  ?>
                            <tr>
                                <th style="padding: 8px 0; font-size: 11px;" <?php if($section->section_type == "SUNGLASSES" || $section->section_type == "MOSAIC") echo 'style="width:50%"'?>><?php echo $section_titles[0] ?></th>

                                <?php if($section->section_type == "MOSAIC" || $section->section_type == "SUNGLASSES"): ?>
                                <th style="padding: 8px 0; font-size: 11px;" <?php if($section->section_type == "SUNGLASSES" || $section->section_type == "MOSAIC") echo 'style="width:50%"'?>><?php echo $section_titles[1] ?></th>
                                <?php endif; ?>
                        ...
                        <thead style="text-align:center; color:white ">
                            ...
                            <tr>
                                <th style="padding: 8px 0; font-size: 11px;"<?php if($section->section_type == "SUNGLASSES" || $section->section_type == "MOSAIC") echo 'style="width:50%"'?>><?php echo $section_titles[2] ?></th>
                                <?php if($section->section_type == "MOSAIC" ): ?>
                                <th style="padding: 8px 0; font-size: 11px;"<?php if($section->section_type == "SUNGLASSES" || $section->section_type == "MOSAIC") echo 'style="width:50%"'?>><?php echo $section_titles[3] ?></th>
                                <?php endif; ?>
                    ...
                    <table align="center" style="background-color:#011424; width:100%; max-width:650px; height:auto; column-gap:10px; margin-top: 20px; border-collapse:separate; border-spacing:8px; border-radius:3px">
                        <thead style="text-align:center; color:white ">
                            <tr>
                                <th style="width:100%;padding: 8px 0; font-size: 11px;" colspan="3">Best offers</th>
                            </tr>
                        </thead>
                        <tbody style="text-align:center">
                            <?php 
                                            ...
                                            <div style="padding:3px; height: 30%">
                                                ...
                                                <div style="height:auto; width:100%; background-color:none;">
                                                    ...
                                                    <?php if($productModel->get_discounted_percentage($promoted_products[$i]->product_id) > 0): ?>
                                                        <span style="font-size:14px; font-weight:bold"><?php echo($productModel->_discounted_price($promoted_products[$i]->product_id)); ?> <?php echo CURRENCY ?></span>
                                            ...
                                            <div style="padding:3px; height: 30%">
                                                ...
                                                <div style="height:auto; width:100%; background-color:none">
                                                    ...
                                                    <?php if($productModel->get_discounted_percentage($promoted_products[$i+1]->product_id) > 0): ?>
                                                        <span style="font-size:14px; font-weight:bold"><?php echo($productModel->_discounted_price($promoted_products[$i+1]->product_id)); ?> <?php echo CURRENCY ?></span>
                                                        <span style="text-decoration:line-through; margin:0px; color:#2c2c2c;font-size:.8rem;">
                                            ...
                                            <div style="padding:3px; height: 30%">
                                                ...
                                                <div style="height:auto; width:100%; background-color:none">
                                                    ...
                                                    <?php if($productModel->get_discounted_percentage($promoted_products[$i+2]->product_id) > 0): ?>
                                                        <span style="font-size:14px; font-weight:bold"><?php echo($productModel->_discounted_price($promoted_products[$i+2]->product_id)); ?> <?php echo CURRENCY ?></span>
                                                        <span style="text-decoration:line-through; margin:0px; color:#2c2c2c;font-size:.8rem;">
