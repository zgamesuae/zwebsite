<?php
    ...
    // getting the products with attribute new
    $sql="select * from products where products.status='Active' AND show_this_product_in_home_page='Yes' AND products.precedence<'1000' AND FIND_IN_SET('7',products.type)";
    $sql=$sql."order by precedence asc limit 12";
    $products=$userModel->customQuery($sql); 
?>

<?php if($products){ ?>
<div class="container-fluid home-sec categoriesarea">
        ...
        <div class="row" id="cate_aear_row_top_minus_margin">
            <div class="col-md-10 mb-4 mt-3" style="margin:auto">
                <div class="sec_title text-center text-white">
                    <h2>NEW IN ACCESSORIES</h2>
                    <a href="<?php echo base_url();?>/product-list?new_realesed=Yes&type=7" class="right_posiation_buttton bnt btn-primary">View All</a>
                </div>
            </div>
                    ...
                    <div class="item">
						...
						if($v->discount_percentage > 0 && false){
                            ...
                            <div class="product_box_content">
                                ...
                                <?php  if($v->discount_percentage > 0 ){ ?>
