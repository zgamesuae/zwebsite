<?php  
    $sql="select * from products where products.status='Active' AND show_this_product_in_home_page='Yes' AND products.type=5 AND products.precedence>'1000'";
    $sql=$sql."order by precedence asc limit 20";
  
    $products=$userModel->customQuery($sql); ?>

<!-- Discover your next favorit game -->
<!-- <div class="container-fluid categoriesarea" style="background-image: url('<?php echo base_url();?>/assets/uploads/<?php echo $cms[7]->image;?>');"> -->
<div class="container-fluid categoriesarea home-sec">

    <div class="Abvd">
        <div class="row" id="cate_aear_row_top_minus_margin">
            <div class="col-md-10 mb-4 mt-3" style="margin:auto">
                <div class="sec_title text-center text-white">
                    <h2>MORE GAMES</h2>
                    <a href="<?php echo base_url();?>/product-list?type=5" class="right_posiation_buttton bnt btn-primary">View All</a>
                </div>
            </div>
            <div class="col-md-10 pb-4" style="margin:auto">
                        ...
                        <div class="product_box shadow-none bg-white rounded overflow-hidden">
                            <a href="<?php echo base_url();?>/product/<?php echo $v->product_id;?>">
                                <div class="product_box_image">
                                    <?php 
						if($v->discount_percentage > 0 && false){
							?>
                            ...
                            <div class="product_box_content">
                                <?php $p_title=(strlen($v->name) > 45) ? substr($v->name,0,40)."..." : $v->name; ?>
                                <h5>
						...
						?>
                                <div class="pricing-card">
                                    <div class="card-subtitle">
                                        <span><?php echo bcdiv($v->price, 1, 2);?><span> <?php echo CURRENCY ?> </span>
                                        </span>
                                    </div>
                                    <p class="offer-price card-text">
                                        <?php echo bcdiv($v->price - ($v->discount_percentage*$v->price)/100, 1, 2);?><span><?php echo CURRENCY ?></span>
                                    </p>
                                </div>
                                <?php } else {
					?>
                                ...
                                <div class="pricing-card">
                                    ...
                                    <p class="offer-price card-text">
                                        <?php echo bcdiv($v->price, 1, 2);?><span><?php echo CURRENCY ?></span></p>
                                </div>
