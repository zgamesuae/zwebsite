...
if($pc_parts){
    $car_params = [
        ...
        "section_division" => [
            ...
            ["img"=> base_url()."/assets/others/carrousel_cat_pc_parts_ram.jpg" , "link" => base_url()."/gaming-accessories/ram"],
        ],
        "no_bg" => false,
        "bts_font" => false
    ];
...
<div class="container-fluid home-sec pt-4 pb-4">
    <div class="row j-c-center">
        <div class="text-justify col-md-12 col-sm-12 col-lg-10" style="color: rgb(247, 247, 247)">
            <p>
