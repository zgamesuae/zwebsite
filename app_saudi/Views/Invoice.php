  ...
  <article>
    ...
    <table class="balance">
      ...
      <tr>
        ...
        <td><span>
            <?php $taxable = bcdiv($order_details["sub_total"] / 1.15 , 1 , 2); echo $taxable ?>
          </span> <span data-prefix>
            <?php echo lg_get_text("lg_102") ?>
          </span></td>
      </tr>
      ...
      <tr>
        <th><span>
        <?php 
          echo $charge["arabic_title"] ?> <br> <?php echo $charge["title"];
          if ($charge["type"] == "Percentage") echo " ({$charge["value"]}%)"; 
        ?>
          </span></th>
        <td><span>
            <?php echo bcdiv($charge["price"] / 1.15 , 1 , 2) ?>
          </span> <span data-prefix>
            <?php echo lg_get_text("lg_102") ?>
          </span></td>
      </tr>
      ...
      <tr>
        ...
        <td><span>
            <?php echo bcdiv(($taxable + $taxable_charges - $taxable_discount) * 0.15 , 1 , 2) ?>
          </span> <span data-prefix>
            <?php echo lg_get_text("lg_102") ?>
          </span></td>
      </tr>
      ...
      <!-- PAID AMOUNT -->
      <?php if($order_details["wallet_use"] == "Yes" && (int)$order_details["wallet_used_amount"] > 0 && false): ?>
      <tr>
        <th><span>المبلغ المدفوع <br> Total paid</span></th>
        <td><span>
            <?php echo $order_details["wallet_use_amount"] ?>
          </span> <span data-prefix>
            <?php echo lg_get_text("lg_102") ?>
          </span></td>
      </tr>
