                                                ...
                                                <div class="col-12 row m-0 my-1 px-0 py-2 border-bottom">
                                                    <div class="col-auto p-2 mx-2 border payment-method d-flex a-a-center">
                                                        <label class="checkbox light-green d-flex m-0" for="installation-checkbox" style="cursor: pointer">
                                                            ...
                                                            <img src="https://zgames.ae/assets/others/zg_payment_methods.jpg" class="" style="max-width: 100px">
                                                        </label>
                                                    </div>
                                                </div>
                                                <!-- END ONLINE PAYMENT -->
                                                ...
                                                <div class="col-12 row px-0 py-2 m-0 my-1 align-items-center border-bottom">
                                                    ...
                                                    <div class="col-6 p-2">
                                                        <p class="m-0 <?php echo text_from_right() ?>">
                                                            ...
                                                            <i class="fa-solid fa-circle-info mx-2" type="button" data-tabby-language="<?php if(get_cookie('language') == 'AR') echo 'ar'; else echo 'en'   ?>" data-tabby-info="installments" data-tabby-price="<?php echo $total+$cart_charges["total_charges"] ?>" data-tabby-currency="<?php echo CURRENCY?>"></i>
                                                        </p>
                                                    </div>
                                                ...
                                                <div class="col-12 row px-0 py-2 m-0 my-1">
                                                    <div class="col-auto p-2 mx-2 border payment-method d-flex a-a-center">
                                                        <label class="checkbox light-green d-flex m-0" for="installation-checkbox2" style="cursor: pointer">
                                                            ...
                                                            <img src="https://zgames.ae/assets/others/zg_cash_on_delivery.jpg" class="" style="max-width: 100px">
                                                        </label>
                                                    </div>
                                                </div>
