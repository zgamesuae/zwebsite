<?php
    ...
    $sql="select * from products where products.status='Active' AND show_this_product_in_home_page='Yes' AND products.precedence<'1000' AND products.type='5'";
        ...
        <div class="row" id="cate_aear_row_top_minus_margin">
            <div class="col-md-10 mb-4 mt-3" style="margin:auto">
                <div class="sec_title text-center text-white">
                    ...
                    <a href="<?php echo base_url();?>/product-list?new_realesed=Yes&type=5" class="right_posiation_buttton bnt btn-primary">View All</a>
                </div>
            </div>
