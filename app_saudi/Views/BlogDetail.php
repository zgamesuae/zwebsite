              ...
              <div class="col-12 px-0 py-3">
                ...
                <div class="col-12 px-1">
                  <p class="blog-date" style="color: rgb(56, 56, 56)">
                    <?php echo (new \DateTime($blog[0]->created_at , new \DateTimeZone("Asia/Dubai")))->format("D. d F Y - H:i") ?>
                  </p>
                </div>
              </div>
                    ...
                    <li class="blog-row col-12 p-0 m-0 row my-3 p-1 py-2 align-items-start">
                      ...
                      <div class="col-8 px-0 px-md-1 row">
                        ...
                        <div class="col-12 blog-date">
                          <span>
                            <?php echo (new \DateTime($blog->created_at , new DateTimeZone("Asia/Dubai")))->format("D. d F Y - H:i") ?>
                          </span>
                        </div>
