                    ...
                    <div class="col-12 my-4">
                        <div class="row j-c-spacenbetween">
                            <div class="col-3 pr-0">
                                <input required name="country_code" class="form-control py-4" type="text" autocomplete="0" value="+966" disabled>
                            </div>
                            <div class="col-9">
                ...
                <form class="col-12 px-0 px-lg-3" id="loginWithOTP'.$i.'" method="POST" action="'.base_url().'/auth/loginWithOTP" autocomplete="off">
                    ...
                    <div class="row col-12 mx-0 px-0">
                        <div class="col-3 my-4 pr-0">
                            <input required name="country_code" class="form-control py-4" type="text" placeholder="" autocomplete="0" value="+966" readonly="readonly" >
                        </div>
