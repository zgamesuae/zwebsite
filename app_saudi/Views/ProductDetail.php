...
<!-- Page location links -->
<div class="container breadcrumbs_nav <?php text_from_right() ?>" <?php content_from_right() ?>>
    <ul>
...
<div class="container pt-2 padding_unset_none pb-4">
        ...
        <div class="col-md-5 pt-3 " <?php content_from_right() ?>>
            <div class="products_details" product_id="<?php echo $products[0]->product_id?>">
                ...
                <div class="brand pt-2 pb-2 d-flex align-items-center row col-12">
                    <h6 class="m-0"><strong><?php echo lg_get_text("lg_170") ?>:</strong></h6>
                    <a href="<?php echo $brandModel->get_brand_url($brands[0]->id)?>"><span class="pl-2"> <?php lg_put_text(@$brands[0]->title , @$brands[0]->arabic_title);?> </span></a>
                ...
                <?php if($products[0]->type == 12): ?>
                    <div class="d-flex col-12 pt-2 pb-2 px-0">
                        <ul class="pp_additional_infos">
                            ...
                            <li><?php echo lg_get_text("lg_172") ?></li>
                        </ul>
                    </div>
                <?php endif;?>
                ...
                <div class="brand pt-2 pb-2 d-flex align-items-center">
                    <h6 class="m-0"><strong><?php echo lg_get_text("lg_53") ?>:</strong></h6>
                ...
                <div class="pricing-card mt-2">
                    <div class="card-subtitle <?php text_from_right() ?>">
                        ...
                        if($productModel->get_discounted_percentage($products[0]->product_id) > 0){
                            $price = ($products[0]->discount_rounded == "Yes") ? round(bcdiv($products[0]->price - ($products[0]->discount_percentage*$products[0]->price)/100, 1, 2)) : bcdiv($products[0]->price - ($products[0]->discount_percentage*$products[0]->price)/100, 1, 2) ;
                        }
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <p class="offer-price card-text d-flex m-0">
                            <span style="font-size: inherit;font-weight:inherit">
                                <?php 
                                    if($products[0]->discount_rounded == "Yes")
                                    echo round(bcdiv(@$products[0]->price - (@$products[0]->discount_percentage*@$products[0]->price)/100, 1, 2));
                                    else
                                    echo bcdiv(@$products[0]->price - (@$products[0]->discount_percentage*@$products[0]->price)/100, 1, 2);
                                ?>
                            </span>
                ...
                <div class="specification">
                    <?php if(@$age[0]->image){?>
                    <div class="icon">
                        <img alt="Age" src="<?= base_url() ?>/assets/uploads/<?php echo @$age[0]->image;?>">
                        <span><?php echo lg_get_text("lg_174") ?> <?php echo @$age[0]->title;?></span>
                    </div>
                    <?php } ?>
                    <div class="icon">
    ...
    <div class="row j-c-spacearound">
        ...
        <div class="col-md-auto col-6 text-center mt-3">
            ...
            <h6><?php echo lg_get_text("lg_129") ?></h6>
        ...
        <div class="col-md-auto col-6 text-center mt-3">
            <h6><?php echo lg_get_text("lg_128") ?></h6>
            <div class="list_of_burron">
                <?php  
        ...
        <div class="col-md-auto col-6 text-center   mt-3">
            <h6><?php echo lg_get_text("lg_131") ?></h6>
            <div class="list_of_burron">
                <?php  
                $ar= array_values(array_unique(explode(",",$sf))); 
        ...
        <div class="col-md-auto col-6 text-center mt-3">
            <h6><?php echo lg_get_text("lg_130") ?></h6>
            <div class="list_of_burron">
                <?php  
                $ar= array_values(array_unique(explode(",",$sf))); 
        ...
        ?>
        <div class="col-md-auto col-6 text-center mt-3">
            <h6><?php echo lg_get_text("lg_132") ?></h6>
            <div class="list_of_burron">
                <?php  
                $ar= array_values(array_unique(explode(",",$sf))); 
