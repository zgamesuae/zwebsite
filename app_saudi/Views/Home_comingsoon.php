<?php
    ...
    $sql="select * from products where products.status='Active' AND show_this_product_in_home_page='Yes' and products.pre_order_enabled='Yes'";
        ...
        <div class="row" id="cate_aear_row_top_minus_margin">
            <div class="col-md-10 mb-4 mt-3" style="margin:auto">
                <div class="sec_title text-center text-white">
                    <h2>COMING SOON</h2>
                    <a href="<?php echo base_url();?>/product-list?pre-order=enabled" class="right_posiation_buttton bnt btn-primary">View All</a>
                </div>
            </div>
