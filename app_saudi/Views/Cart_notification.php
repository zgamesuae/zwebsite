            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:25%; height: 130px; padding:30px 8px 8px; text-align: center; background-color: #d9dfec; border-top-right-radius:15px; border-bottom-right-radius:15px; vertical-align:top;">
                        ...
                        <?php 
                            $discount = $productModel->get_discounted_percentage($product->product_id);
                            $is_rounded = $productModel->is_discount_rounded($product->product_id);
                            if($discount > 0 && $is_rounded == 'Yes')
                            $price = round(bcdiv($product->price - ($product->price * $discount / 100) , 1 , 2));

                            else if($discount > 0 && $is_rounded == 'No')
                            $price = bcdiv($product->price - ($product->price * $discount / 100) , 1 , 2);
        ...
        <tbody>
            ...
            <tr>
                <td style="text-align: left; padding: 0 10px">
                    <a style="text-decoration:none; margin:0; fill:#363636" href="https://www.facebook.com/zamzam.games">
                        <img style="height:22px; vertical-align:middle;" src="https://zamzamgames.com/assets/uploads/ns_facebook.png" alt="">
                    </a>
                    <a style="text-decoration:none; margin:0 10px; fill:#363636" href="https://www.instagram.com/zamzam.games">
                        <img style="height:22px; vertical-align:middle;" src="https://zamzamgames.com/assets/uploads/ns_instagram.png" alt="">
                    </a>
                    <a style="text-decoration:none; margin:0; fill:#363636" href="https://www.tiktok.com/@zgames">
