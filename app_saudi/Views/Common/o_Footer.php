...
$sql="select * from master_category where parent_id='0' and show_in_menu='Yes' order by precedence asc";
                    ...
                    <ul class="m-0 header_contact_info p-0 footer_firts_column">
                        ...
                        <li class="pb-3">
                            <a href="<?php echo base_url();?>">
                                ...
                                <span <?php if(get_cookie("language") == "AR") echo "class='m-0 mr-2'" ?>>zamzamgames.com</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="footer_inner">
                    ...
                    <ul>
                        ...
                        <li <?php if(get_cookie("language") == "AR") echo 'class="text-right"'; ?>>
                            <a href="<?php echo base_url();?>/product-list?category=<?php echo $value->category_id;?>"><?php if(get_cookie("language") == "AR") echo $value->category_name_arabic; else echo $value->category_name;?></a>
                        </li>
                        <?php }} ?>
                    </ul>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="footer_payment_logo row m-0 j-c-center">
                    ...
                    <div class="payment_logo col-auto m-0 my-1 p-0">
                        <img class="mx-3" src="<?php echo base_url() ?>/assets/others/union_pay.png" alt="American Express">
                    </div>
