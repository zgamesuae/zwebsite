...
<body class="page-<?php echo @$uri1;?>">
    ...
    <div class="add_to_card_popup  show_indesktop">
        ...
        <div class="card_pop_foot j-c-arround">
            <a href="<?php echo base_url()?>/cart" class="col-5 m-0 border-0 mx-2"> 
                <div class="row col-12 m-0 j-c-spacebetween p-0 a-a-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                    ...
                    <span  class="m-0">View cart</span>
                </div>
            </a>
            <a class="btn-primary col-5 mx-2" href="<?php echo base_url()?>/checkout">
                <div class="row col-12 m-0 j-c-spacebetween p-0 a-a-center">
                    <span  class="m-0">Checkout</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                        <path fill="none" d="M0 0h24v24H0z"></path>
    ...
    <header class="container-fluid header p-0" id="nav_bar" >
        <div class="container-fluid d-flex-row j-c-center header_top px-0 py-1">
            <div class="row col-lg-10 col-md-12 col-sm-12 justify-content-between a-a-center <?php echo content_reversed() ?>">
                <div class="col-md-auto col-sm-12 px-0">
                    <div class="row header_top_left a-a-center pt-0">
                      ...
                      <div class="col-auto d-flex a-c-center our-stores">
                          ...
                          <a href="<?php base_url() ?>/page/ourstores" class="pl-2"><?php echo lg_get_text("lg_10") ?></a>
                      </div>
                    </div>
                </div>
                <div class="col-md-auto col-sm-12 px-0">
                    <div class="header_top_right a-a-center <?php echo content_reversed() ?>" >

                        <!-- Language select -->
                        <div class="col-auto">

                            <div class="dropdown">
                                <button class="dropdown-toggle a-a-center row j-c-spacebetween border-0" style="background:none; color:white"  data-bs-toggle="dropdown" aria-expanded="false">
                                    
                                    <?php if(null !== get_cookie("language") && get_cookie("language") == "AR"):?>
                                    <div class="row my-1 a-a-center col-auto px-1 m-0 j-c-spacebetween">
                                        <p class="col-auto m-0 pl-0">العربية</p>
                                ...
                                <ul class="dropdown-menu">
                                    <li class="col-auto">
                                        <div class="dropdown-item px-0 m-0" onClick="change_language('EN')">
                                    ...
                                    <li class="col-auto">
                                        <div class="dropdown-item px-0 m-0" onClick="change_language('AR')">
                                            <div class="row my-1 a-a-center col-12 px-0 m-0 j-c-spacebetween">
                                                <p class="col-auto m-0">العربية</p>
                                                <img class="col-auto p-0" src="<?php echo base_url()?>/assets/others/ARA.png" style="max-height:22px" alt="">
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="user_acount mr-3">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu border-0 p-3">
                                    <li class="pb-2 <?php text_from_right() ?>"><a href="<?php echo base_url();?>/profile/"><?php echo lg_get_text("lg_88") ?></a></li>
                                    <li class="pb-2 <?php text_from_right() ?>"><a href="<?php echo base_url();?>/profile/changePassword"><?php echo lg_get_text("lg_89") ?></a></li>
                                    <li class="pb-2 <?php text_from_right() ?>"><a href="<?php echo base_url();?>/logout"><?php echo lg_get_text("lg_90") ?></a></li>
                                </ul>
                            </div>
                        </div>
                        <?php } else { ?>
                        ...
                        <div class="register" data-toggle="modal" data-target="#login-modal" data-form="register" onClick="get_form(this.getAttribute('data-form'))">
                            ...
                            <span><?php echo lg_get_text("lg_84") ?></span>
                        </div>
                        <?php } ?>
        ...
        <div class="container-fluid d-flex-row header_middle j-c-center pb-3 px-0" <?php echo content_from_right() ?>>
            <div class="row col-sm-12 col-md-12 col-lg-10 a-a-center j-c-spacebetween py-2">
                <div class="col-md-3 d-flex-row j-c-start p-0 a-a-center" id="logo_headre_s">
                ...
                <div class=" col-sm-12 col-md-5 p-md-0" id="search_column_main">
                    <div class="search_form">
                        <div class="container p-0" style="z-index:10; width: 100%; max-height:690px; min-width:350px; overflow-y: scroll; position: absolute; top:100%; background-color:gray">
                            <div class="result row col-12 j-c-center m-0 px-0">
                            </div>
                        </div>

                        <form class="search_form_main m-0" action="<?php echo base_url();?>/product-list">
                            <input type="text" id="search_bar" class="form_control" placeholder="<?php echo lg_get_text("lg_118") ?>" name="keyword"
        ...
        <div class="container-fluid menu_bottom_div " <?php echo content_from_right() ?>>
                        ...
                        <ul class="main_menu">
                            ...
                            ?>
                                ...
                                <div class="dropdown_m_menu">
                                    <a class="drop_down_enable" href="<?php echo $lnk;?>"><?php if(get_cookie("language") == "AR") echo $value->category_name_arabic; else echo $value->category_name;?></a>
                                    ...
                                    <svg style="display: none;" onClick="rotat_line(this)" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" width="24" height="24" xml:space="preserve">
                                    	<path style="fill:none;" d="M25,46.4C13.2,46.4,3.6,36.8,3.6,25S13.2,3.6,25,3.6S46.4,13.2,46.4,25S36.8,46.4,25,46.4z"/>
                                    	<path d="M25,5.6c10.7,0,19.4,8.7,19.4,19.4S35.7,44.4,25,44.4S5.6,35.7,5.6,25S14.3,5.6,25,5.6 M25,1.6C12.1,1.6,1.6,12.1,1.6,25
                                    		c0,12.9,10.5,23.4,23.4,23.4c12.9,0,23.4-10.5,23.4-23.4C48.4,12.1,37.9,1.6,25,1.6L25,1.6z"/>
                                    	<line style="fill:none;stroke:#FFFFFF;stroke-width:4;stroke-miterlimit:10;" x1="12.7" y1="25" x2="37.3" y2="25"/>
	                                    <line class="to_turn" style="fill:none;stroke:#FFFFFF;stroke-width:4;stroke-miterlimit:10;" x1="25" y1="37.3" x2="25" y2="12.7"/>
                                    </svg>
                                </div>
                                        ...
                                        <ul class="open_menu_mobile_s">
                                            ...
                                            <li>
                                                <div class="dropdown_m_menu remove_after_arrow">
                                                    <a href="<?php echo(base_url()."/".$links[$v2->category_id]); ?>" class="drop_down_enable"><span> <?php if(get_cookie("language") == "AR") echo $v2->category_name_arabic; else echo $v2->category_name;?></span>
                                                ...
                                                <ul class="open_menu_mobile_s">
                                                    ...
                                                    ?>
                                                    <li>
                                                        <a href="<?php echo(base_url()."/".$links[$v3->category_id]); ?>"><span> <?php if(get_cookie("language") == "AR") echo $v3->category_name_arabic; else echo $v3->category_name;?></span>
                                                        </a>
                                                    </li>
                                                    <?php 
                                                       }
                                            ...
                                            <?php
                                             ...
                                             ?>
                                            <li>
                                                <a href="<?php echo(base_url()."/".$links[$v2->category_id]);?>"><span><?php if(get_cookie("language") == "AR") echo $v2->category_name_arabic; else echo $v2->category_name;?></span> </a>
                                            </li>
                                            <?php
                                                    }
                                                  }
                            ...
                            ?>
                            <li><a href="<?php echo $lnk;?>"><?php if(get_cookie("language") == "AR") echo $value->category_name_arabic; else echo $value->category_name;?></a></li>
                            <?php 
                                }
                            ...
                            <li>
                                <div class="dropdown_m_menu">
                                    <span style="color:white" class="drop_down_enable" href=""><?php echo lg_get_text("lg_81") ?></span>
                                    <!--<svg style="display: none;" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">-->
                                    <!--    <path fill="none" d="M0 0h24v24H0z" />-->
                                    <!--    <path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-5-9h10v2H7v-2z" />-->
                                    <!--</svg>-->
                                ...
                                <ul class="drop_drow_menu">
                                    <div class="drp_menu">
                                        <ul class="open_menu_mobile_s">
                                        <?php
                                            $sql="select * from master_category where parent_id='0' AND status='Active' order by precedence asc LIMIT 6,20";
                                            $master_category=$userModel->customQuery($sql);
                                        ...
                                        ?>
                                            <li>
                                                <div class="dropdown_m_menu remove_after_arrow">
                                                    <a href="<?php echo($lnk); ?>" class="drop_down_enable"><span> <?php if(get_cookie("language") == "AR") echo $value->category_name_arabic; else echo $value->category_name;?></span>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul class="open_menu_mobile_s">
                                                            <?php
                                                                foreach ($cat3 as $v3) {
                                                            ?>
                                                                <li><a href="<?php echo base_url()."/".$links[$v3->category_id];?>"><?php if(get_cookie("language") == "AR") echo $v3->category_name_arabic; else echo $v3->category_name;?></a></li>
                                                            <?php
                                                                }
                                                            ?>
                                                ...
                                                ?>
                                                    <li><a href="<?php echo base_url()."/".$links[$v2->category_id];?>"> <?php if(get_cookie("language") == "AR") echo $v2->category_name_arabic; else echo $v2->category_name;?></a></li>
                            ...
                            <li style="font-weight:bold; background-color:#4a915e; box-shadow: inset black 1px 1px 3px"><a href="<?php echo base_url() ?>/product-list/offers"><?php echo lg_get_text("lg_82") ?></a></li>
                            <?php endif; ?>

                            <?php if($productModel->preorders_exist()): ?>
                            <li style="font-weight:bold; background-color:#6e4a91; box-shadow: inset black 1px 1px 3px"><a href="<?php echo base_url() ?>/product-list/pre-orders"><?php echo lg_get_text("lg_34") ?></a></li>
                            <?php endif; ?>

                        </ul>
                    </div>
                    <div class="login_mobile_button" style="display: none">
                        <a href="javascript:void();" data-toggle="modal" data-target="#login-modal" data-form="login" onClick="get_form(this.getAttribute('data-form'))"><?php echo lg_get_text("lg_83") ?></a>
                        <a href="javascript:void();" data-toggle="modal" data-target="#login-modal" data-form="register" onClick="get_form(this.getAttribute('data-form'))"><?php echo lg_get_text("lg_84") ?></a>
                    </div>
                </div>
            </div>
        </div>
