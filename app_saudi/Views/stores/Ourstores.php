<?php
    ...
    $uae_cities = ["Dubai" , "Sharjah" , "Al Ain"];
                                    ...
                                    <div class="store-body d-flex flex-column a-a-center">
                                        ...
                                        <div class="row pt-4 px-3 mt-4 store-detail">
                                            ...
                                            <div class="col-12 store-timing">
                                                ...
                                                <ul class="px-1">
                                                    <li><?php echo lg_get_text("lg_63").": ".(new \DateTime($store->weekdays_start , new \DateTimeZone("Asia/Dubai")))->format("h:i A")."-".(new \DateTime($store->weekdays_end , new \DateTimeZone("Asia/Dubai")))->format("h:i A") ?></li>
                                                    <li><?php echo lg_get_text("lg_64").": ".(new \DateTime($store->weekends_start , new \DateTimeZone("Asia/Dubai")))->format("h:i A")."-".(new \DateTime($store->weekends_end , new \DateTimeZone("Asia/Dubai")))->format("h:i A") ?></li>
                                                </ul>
                                            </div>
                                            <?php else: ?>
