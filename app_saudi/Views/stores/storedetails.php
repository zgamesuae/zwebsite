            ...
            <div class="row about">
                ...
                <div class="col-12">
                    <p class=" <?php text_from_right() ?>">
                        <span style="color: #89ff89"> <?php echo lg_get_text("lg_63") ?>: </span>  <?php echo (new \DateTime($store->weekdays_start , new \DateTimeZone("Asia/Dubai")))->format("h:i A")."-".(new \DateTime($store->weekdays_end , new \DateTimeZone("Asia/Dubai")))->format("h:i A") ?> <br>
                        <span style="color: #89ff89"><?php echo lg_get_text("lg_64") ?>:</span>  <?php echo (new \DateTime($store->weekends_start , new \DateTimeZone("Asia/Dubai")))->format("h:i A")."-".(new \DateTime($store->weekends_end , new \DateTimeZone("Asia/Dubai")))->format("h:i A") ?>
                    </p>
                </div>
            </div>
        </div>
