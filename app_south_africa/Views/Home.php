...
<div class="container-fluid home-sec">
    <div class="row services_area pt-4 pb-4" id="services_area">
        ...
        <div class="container-fluid full_cate_sliders m-0">
            <div class="owl-carousel ws-shopby-genre-carousel owl-theme col-lg-10 .col-sm-12 p-0" style="margin:auto">
                ...
                <div class="item row align-items-end justify-content-center" style="color: white;font-weight: 300; min-height: 200px">
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Fighting</h4>
                    </div>
                  </div>
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Sport</h4>
                    </div>
                  </div>
                ...
                <div class="item row align-items-end justify-content-center" style="color: white;font-weight: 300; min-height: 200px">
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Shooter</h4>
                    </div>
                  </div>
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Racing</h4>
                    </div>
                  </div>
                ...
                <div class="item row align-items-end justify-content-center" style="color: white;font-weight: 300; min-height: 200px">
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Horror</h4>
                    </div>
                  </div>
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Action</h4>
                    </div>
                  </div>
                ...
                <div class="item row align-items-end justify-content-center" style="color: white;font-weight: 300; min-height: 200px">
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Adventure</h4>
                    </div>
                  </div>
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Strategy</h4>
                    </div>
                  </div>
                ...
                <div class="item row align-items-end justify-content-center" style="color: white;font-weight: 300; min-height: 200px">
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Multiplayer</h4>
                    </div>
                  </div>
                  ...
                  <div class="col-12 d-flex flex-column justify-content-center ws-genre-item my-3 p-0">
                    ...
                    <div class="col-12 p-0">
                      <h4 class="text-center p-2 m-0" style="background-color: #2c3240">Music</h4>
                    </div>
                  </div>
...
<div class="container-fluid home-sec pt-4 pb-4">
    <div class="row j-c-center">
        <div class="text-justify col-md-12 col-sm-12 col-lg-10" style="color: rgb(15, 15, 15)">
            <p>
