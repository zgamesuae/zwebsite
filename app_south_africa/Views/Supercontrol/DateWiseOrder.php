                                    ...
                                    <table id="dateWiseOrder"  class=" " style="width:100%; " >
                                        ...
                                        <tbody>
                                            ...
                                            foreach($orders as $k=>$v){
                                                ...
                                                // total COD 
                                                $sql="select sum(total) as total from orders where date(created_at)='$dd' AND payment_method='Cash on devlivery' AND payment_status='Paid' group by date(created_at) order by date(created_at) desc";
