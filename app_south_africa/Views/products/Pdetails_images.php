            ...
            <!-- Carousel -->
            <div id="carousel" class="single_page_slider carousel d-flex justify-content-center slide gallery" data-ride="carousel" data-interval="false" data-interval="10000">
            ...
            <!-- Carousel Navigatiom -->
            <div id="carousel-thumbs" class="carousel slide d-flex justify-content-center" data-ride="carousel" data-interval="10000">
                <div class="carousel-inner">
                    <!-- Thumb Navigation buttons -->
                        ...
                        <a class="carousel-control-prev" style="background: black; width: 25px!important" href="#carousel-thumbs" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only"><?php echo lg_get_text("lg_166") ?></span>
                        </a>
                        <a class="carousel-control-next" style="background: black; width: 25px!important" href="#carousel-thumbs" role="button" data-slide="next">
                    ...
                    <div class="carousel-item <?php if($k==0) echo 'active';?>" data-slide-number="<?php echo $k;?>">
                        <div class="row mx-0">
                            ...
                            <?php 
                            // if(   
                            // (count($product_image) < 4  &&  count($product_image)==1 && $i==1 ) ||  
                            // (count($product_image) < 4  &&  count($product_image)==2 && $i==2 ) ||  
                            // (count($product_image) < 4  &&  count($product_image)==3 && $i==3 ) || 
                            // @$products[0]->youtube_link!="" && $i==3 || 
                            // @$products[0]->youtube_link=="" && $i==4 || 
                            // count($product_image)==1 || 
                            // count($product_image)==2 && $i>1
                            // ){ 
                                if($k == (sizeof($product_image)-1) || $k == 3 ){
                                $i=1; 
                              ?>
                        </div>
                    </div>
