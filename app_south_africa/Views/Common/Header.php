...
<head>
    ...
    ?>
     ...
     <title><?php  if(@$prod){ echo "Shop $prod->name with ".$settings[0]->business_name." in South Africa - johannesbourg,Cape Town,Pretoria $sku";}else{ echo ucwords($settings[0]->business_name);}?></title>
