        ...
        case 'login':
            ...
            <div class="block2 m-0 p-0 row col-12">
                <form id="buyer_login_form'.$i.'" method="POST" class="col-12 px-0 px-lg-3" action="'.base_url()."/auth/LoginValidation".'" autocomplete="off">
                    ...
                    <!-- Buttons -->
                    <div class="row j-c-spacebetween px-0 col-12 my-3 mx-0">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="btn btn-secondary col-12" style="border: none!important;" data-form="login_otp" onClick="get_form(this.getAttribute(\'data-form\') , \''.$destination.'\')">'.lg_get_text("lg_153").'</div> 
                        </div>
                    </div>
