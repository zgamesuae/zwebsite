...
<div class="col-lg-6">
 ...
 <div id="resetPasswordMessage"></div>
    <button id="forgotLogin" data-toggle="modal" data-target="#jagat-login-modal" style="display:none;" class="btn btn-primary  p-3 w-100" data-form="login" onClick="get_form(this.getAttribute('data-form'))">Click here to login </button>
