                    ...
                    <tr>
                        <td style="padding: 10px 0px 10px 0px; text-align:center">
                            <a href="<?php echo $settings->facebook;?>">
                                <img src="<?php echo base_url()?>/assets/uploads/ns_facebook.png" alt="" style="height: 25px; margin: 0px 10px;">
                            </a>
                            <a href="<?php echo $settings->instagram;?>">
                                <img src="<?php echo base_url()?>/assets/uploads/ns_instagram.png" alt="" style="height: 25px; margin: 0px 10px;">
                            </a>
                            <a href="<?php echo $settings->tiktok;?>">
                                <img src="<?php echo base_url()?>/assets/uploads/ns_tiktok.png" alt="" style="height: 25px; margin: 0px 10px;">
                            </a>
                        </td>
                    </tr>
