        ...
        <div class="row col-12 m-0 p-0 j-c-center" style="position:relative">
            ...
            <div class="row px-sm-0 col-sm-12 col-md-12 col-lg-10 my-3 j-c-center">
                <div class="row col-sm-12 col-lg-10 j-c-center">
                    <h1 class="col-lg-10" style="text-align:center;font-size:1.8rem">Customize your Gaming PC</h1>
                </div>
            </div>
                        ...
                        <div class="row col-12 m-0 my-4 j-c-center">
                            <div class="form-group row my-3 mx-0 px-0 j-c-center col-lg-8 col-sm-12">
                                ...
                                <select class="col-lg-11 col-sm-12 mx-2" name="op_type" id="op_type">
                                    <option selected value="2">Get a quote</option>
                                    <option value="1">Request a callback</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group row my-3 mx-0 px-0 j-c-center col-lg-6 col-sm-12">
                                ...
                                <select class="col-lg-11 col-sm-12 mx-2" name="country" id="country">
                                    ...
                                    <option value="SAOUDI ARABIA">Saudi Arabia</option>
                        ...
                        <div class="row config_infos col-12 m-0">
                            ...
                            <div class="form-group row my-3 mx-0 px-0 j-c-center col-lg-6 col-sm-12">
                                ...
                                <select class="col-lg-11 col-sm-12 mx-2" type="text" name="os" id="os">
                                    ...
                                    <option <?php if(isset($data["os"]) && $data["os"] == "Windows 10") echo "selected"; ?> value="Windows 10">Windows 10</option>
                                    <option <?php if(isset($data["os"]) && $data["os"] == "Windows 11") echo "selected"; ?> value="Windows 10">Windows 11</option>
                                </select>
                            </div>
