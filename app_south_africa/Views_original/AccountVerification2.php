            ...
            <table style="text-align:center; width:100%; height:100%; margin:auto">
                ...
                <tr>
                    <td style="width: 100%;padding:15px">
                        <img src="https://zamzamgames.com/assets/uploads/ZGames-logo-02.png" alt="" style="height:100px;margin:auto;">
                    </td>
                </tr>
                                ...
                                <tr>
                                    <td style="padding: 50px 0">
                                            <div style="background-color:#243d97; padding:15px 20px; border-radius:10px; width:150px; margin: auto;">
                                                <a href="<?php echo base_url();?>/verify/<?php echo @$token;?>" style="text-decoration: none; color: inherit;">
                                    ...
                                    <td style="padding: 25px 0;">
                                        <div style="width:200PX; background-color: none; height:35px; margin: auto;">
                                            <table style="width:100%; height:100%; margin:auto">
                                                <tr>
                                                    <td>
                                                        <a href="<?php echo $settings->facebook?>"><img src="https://zamzamgames.com/assets/uploads/FACEBOOK-02.png" style="height:22px; vertical-align:middle;" alt=""></a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo $settings->instagram?>"><img src="https://zamzamgames.com/assets/uploads/Instagram-02.png" style="height:22px; vertical-align:middle;" alt=""></a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo $settings->tiktok?>"><img src="https://zamzamgames.com/assets/uploads/tiktok-02.png" style="height:22px; vertical-align:middle;" alt=""></a>
                                                    </td>
                                                    <td>
                                                        <a href="<?php echo $settings->youtube?>"><img src="https://zamzamgames.com/assets/uploads/Youtube-02.png" style="height:22px; vertical-align:middle;" alt=""></a>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
