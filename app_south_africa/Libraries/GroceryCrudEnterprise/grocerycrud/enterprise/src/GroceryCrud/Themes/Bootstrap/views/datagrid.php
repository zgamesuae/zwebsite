<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.8.8.10b14e1.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.8.10b14e1' . $minify_or_not . '.js');
