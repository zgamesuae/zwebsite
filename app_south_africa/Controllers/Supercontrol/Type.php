...
class Type extends \App\Controllers\BaseController
{
    public function index()
    {
        ...
        $crud->setTable("type");
        $crud->setSubject("type", "type");
        
        // $crud->setFieldUpload('image', 'assets/uploads', base_url() . '/assets/uploads');

        /*
          $crud->fieldType('type_id','hidden'); 
          $crud->callbackBeforeInsert(function ($stateParameters) {
          $stateParameters->data['type_id'] =  url_title($stateParameters->data['title'], '-', TRUE).'-'.time(); 
