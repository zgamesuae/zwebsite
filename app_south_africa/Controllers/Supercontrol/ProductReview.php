...
class ProductReview extends \App\Controllers\BaseController
{
    public function index()
    {
        ...
        $crud->setTable("product_review");
        $crud->setSubject("Product Review", "Product Review");
        ...
        $crud->requiredFields(["product_id", "rating", "comment", "status"]);
