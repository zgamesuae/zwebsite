...
class Tournament extends \App\Controllers\BaseController{
    ...
    public function register(){
        ...
        if(strtolower($this->request->getMethod()) == 'post'){
            ...
            $form["title"] = "Skull & Bones - Treasure Quest";
            ...
            if($form_validation && !$is_registred){
                ...
                $this->index(["message" =>  "You are already registred" , "data" => $form]);
            }
    ...
    public function cr($code){
        ...
        if(!is_null($res) && sizeof($res) > 0){
            ...
            $this->index([ "success" => true , "message" => "Thank you <b>".$res[0]->first_name." ".$res[0]->last_name."</b> your registration has been confirmed successfully! If you are lucky, You will be contacted soon. </br> Stay Tuned" ]);
        }
