...
defined('STOREID') || define('STOREID', '26184');
defined('AUTHKEY') || define('AUTHKEY', '5wkTk~QNXVj#hGRW');
defined('AUTHKEYREMOTE') || define('AUTHKEYREMOTE', 'nHGgq~n2QJL@P742');
// defined('PGTEST') || define('PGTEST', '0');
defined('PGTEST') || define('PGTEST', '1');
defined('CURRENCY') || define('CURRENCY', 'ZAR');
defined('PHONE_CODE') || define('PHONE_CODE', '+27');
defined('TIME_ZONE') || define('TIME_ZONE', 'Africa/Johannesburg');
