    ...
    public function get_authorization() {
        ...
        if($s){
            ...
            if($content){
                ...
                $this->userModel->do_action("ezpin_api" , "1" , "id" , "update" , ["token"=>$this->token , "last_time_token"=>$this->last_time_token->format("Y-m-d h:i:s") , "token_validity"=>$this->token_validity] , "");
