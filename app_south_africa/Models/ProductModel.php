    ...
    public function search_product($keyword , $result = true){
        ...
        if($keyword !== null && trim($keyword) !== ""){
            ...
            $condition = "products.arabic_name like '%".$keyword."%' and (products.arabic_name is not null or products.arabic_name<>'')";
                ...
                $score_line="";
                $condition .= "((products.name REGEXP '\b".str_replace("'" , "''" , $keyword)."')";
                $score_line.="(products.name REGEXP '\b".str_replace("'" , "''" , $keyword)."')";
                ...
                if(sizeof($words) > 0 && sizeof($match) > 0){
                    ...
                    for($i = 0 ; $i < sizeof($words) ; $i++) {
                        ...
                        $score_line .= " (products.name REGEXP '\b".str_replace("'" , "''" , $words[$i])."' OR products.indexing like '%$metaphone%') ";
                        $condition .= " (products.name REGEXP '\b".str_replace("'" , "''" , $words[$i])."' OR products.indexing like '%$metaphone%') ";
