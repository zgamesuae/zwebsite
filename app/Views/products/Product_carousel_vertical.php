...
<div class="container-fluid <?php if(!isset($no_bg) || !$no_bg): echo "home-sec"; endif; ?> pt-3 best_offers_parent_con">
    <div class="row j-c-center">
        ...
        <div class="row m-0 p-0 col-12 col-xl-10 justify-content-center align-items-center">
            <div class="col-12 col-md-12 col-lg-6 mt-3">
                <?php if(isset($section_background) && sizeof($section_background) > 0 || true): ?>
                    <div class="col-12 p-0 m-0" style="width:100%; max-height: 100%; overflow:hidden; position:relative">
                        <img src="<?php echo $section_background["desktop"] ?>" class="d-none d-xl-block w-100 w-lg-auto h-auto h-lg-100" alt="main section background">
                        <img src="<?php echo $section_background["mobile"] ?>" class="d-sm-block d-xl-none w-100" alt="main section background">
                    </div>
                <?php endif; ?>
            </div>
