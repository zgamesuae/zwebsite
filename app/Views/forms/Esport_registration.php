...
<div class="container-fluid p-0">
    ...
    <div class="container register-form-bg p-0">
        <div class="row j-c-center a-a-center col-12 mx-0 p-0 register-form-header" >
            ...
            <video autoplay loop playsinline class="p-0 m-0" muted="true" style="position:relative; top: -250px">
                <source src="https://media.contentapi.ea.com/content/dam/ea/fc/fc-24/common/homepage/fc24-haaland-goal-1x1.mp4" type="video/webm" />
            </video>
            <img src="https://media.contentapi.ea.com/content/dam/ea/fc/common/global/fc24-logo-nav.svg" style="
                transform: translateX(-50%);
                left: 50%;
                position: absolute;
                bottom: 15px;
    ...
    <div class="container" style="background-image: url('https://media.contentapi.ea.com/content/dam/ea/fc/fc-24/common/ultimate-team/fc24-fut-inc-women-ultimate-means-everyone-bg-1x1.jpg.adapt.320w.jpg') ; background-repeat: repeat; background-size: cover;">
        <div class="col-12 row j-c-center col-12 m-0 mx-0 p-0">
            <div class="col-12 col-md-8 my-5 p-3 register-form-description" style="background-color: #282828">
                ...
                <h1 class="text-center">
                    Welcome to ZGames' EA FC24 Tournament!
                </h1>
                <p class="text-center">
