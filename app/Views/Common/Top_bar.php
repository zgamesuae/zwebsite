...
<div class="row top-bar py-2 " <?php content_from_right() ?>>
    ...
    <div class="col-6 row m-0 justify-content-end">
        <!-- Select Store -->
        <div class="col-auto px-1 d-none d-md-block ws-online-locations">
            <div class="dropdown">
              ...
              <div class="dropdown-menu" style="background: #000d19" aria-labelledby="dropdownMenu2">
                <a href="https://zgames.sa">
                    <div class="dropdown-item d-flex flex-row justify-content-between ">
                        <div class="col-5 p-0 ">
                            <span><?php echo lg_get_text("lg_375") ?></span>
                        </div>
                        <div class="col-auto p-0">
                            <img src="https://zgames.ae/assets/others/stores/saudi_flag.png" height="25px" width="auto" alt="">
                        </div>
                    </div>
                </a>
              </div>
        ...
        <!-- Select Language -->
        <div class="col-auto px-2 d-flex flex-row justify-content-between align-items-center ws-language ms-2">
            <div class="col-auto p-0">
        ...
        <!-- Login to account -->
        <div class="col-auto px-2 d-flex flex-row justify-content-between align-items-center ws-login ms-2">
            <div class="col-auto p-0">
        ...
        <!-- Create Account -->
        <div class="col-auto px-2 d-flex flex-row justify-content-between align-items-center ws-register ms-2">
            <!-- <div class="col-auto">
                <i class="fa-sharp fa-solid fa-globe"></i>
            </div> -->
            <div class="col-auto <?php if($lang == "AR") echo "mr-2"; else echo "ml-2"; ?> p-0">
        ...
        <?php else: ?>
        <!-- User greating -->
        <div class="col-auto px-2 d-flex flex-row justify-content-between align-items-center ws-user-greating ms-2">
            <!-- <div class="col-auto">
                <i class="fa-sharp fa-solid fa-globe"></i>
            </div> -->
