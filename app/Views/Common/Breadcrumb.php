...
?>
<div class="container col-12 col-lg-10 breadcrumbs_nav <?php echo text_from_right() ?>">
   <ul>
      <li>
      ...
      <?php if(@$cat1[0]){ ?>
         <li><span> / &nbsp </span> 
            <a href="<?php echo base_url();?>/<?php echo $uri1;?>?category=<?php echo    @$cat1[0]->category_id   ;?>"><?php lg_put_text(@$cat1[0]->category_name , @$cat1[0]->category_name);  ?></a>
         </li>
      <?php } ?>
      ...
      <?php if(@$cat2[0]){ ?>
         <li><span> / &nbsp </span> 
            <a href="<?php echo base_url();?>/<?php echo $uri1;?>?category=<?php echo    @$cat2[0]->category_id   ;?>"><?php lg_put_text(@$cat2[0]->category_name , @$cat2[0]->category_name);  ?></a>  
         </li>
      <?php } ?>
