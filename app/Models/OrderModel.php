...
class OrderModel extends Model{
    ...
    public function total_cart($user_id,$brand=null,$category=null){
        ...
        $sql = "select products.price,products.discount_percentage,cart.product_id,cart.* from cart inner join products on cart.product_id=products.product_id where cart.user_id='".$user_id."' and products.status='Active'";
