...
class Tournament extends \App\Controllers\BaseController{
    ...
    public function index($return = []){
        ...
        echo view("forms/F1_tournament" , ["table" => $table]);
        echo view("Common/Footer");

    }

    public function fc_24($return = []){
        echo view("Common/Header");
        ...
        if(strtolower($this->request->getMethod()) == 'post'){
            ...
            $rules = [
                ...
                "country" => [
                    ...
                    "errors" => [
                        ...
                        "in_list" => "country not Included in the allowed list" 
                    ]
                ],
                ...
                "phone" => [
                    ...
                    "errors" => [
                        ...
                        "regex_match" => "Enter a valid phone number ex:".PHONE_CODE."520000000",
                    ]
                ],
                "term_cond" => [
                    "rules" => "required",
            ...
            if($form_validation && !$is_registred){
                ...
                if($player_id){
                        ...
                        <div style="height: auto; width:650px; background-color: rgb(232, 234, 238); border: solid 1px rgba(0, 0, 0, 0.171); margin: 15px auto">
                            ...
                            <div style="width: 90%; padding: 25px 25px; text-align: justify; margin: auto; box-sizing: border-box;">
                                ...
                                <div style="margin:30px auto; width: 200px; height: auto; background-color: #22398d; text-align: center;">
                                    <a href="'.base_url().'/tournament/tournament/cr/'.$form["c_code"].'" style="color:white;">
                    ...
                    $this->fc_24([ 
                            "success" => true , 
                            "message" => "Thank you <b>".$form["first_name"]." ".$form["last_name"]."</b> for your intrest, an email was sent to <b>".$form["email"]."</b> to confirm your registration." 
                        ]);
                }
                else{
                    $this->fc_24([ "errors" => ["Ops" => "Operation failed!"] ]);
                }
            }
                ...
                if(!$form_validation)
                $this->fc_24(["errors" =>  $validation->getErrors() , "data" => $form]);
                else
                $this->fc_24(["message" =>  "You are already registred" , "data" => $form]);
            }
    ...
    public function cr($code){
        ...
        if(!is_null($res) && sizeof($res) > 0){
            ...
            $this->fc_24([ "success" => true , "message" => "Thank you <b>".$res[0]->first_name." ".$res[0]->last_name."</b> your registration has been confirmed successfully! If you are lucky, You will be contacted soon. </br> Stay Tuned" ]);
        }

        else
        $this->fc_24([ "success" => false , "message" => "Email address not found or confirmation link has expired."]);
