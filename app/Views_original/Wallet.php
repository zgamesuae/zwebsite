        ...
        <div class="row">
          ...
          <section class="col-lg-8 bg-white">
            <div class="d-flex justify-content-between align-items-center pt-3 pb-4 pb-sm-5 mt-1">
              <h1 class="h3 mb-0">My Wallet </h1><a class="btn btn-primary text-white ps-2" data-toggle="modal" data-target="#addmoney" href="javascript:void(0);"><i class="ci-arrow-left me-2"></i>Add Money</a>
            </div>
            <div class="row">
                    ...
                    <div class="card-body">
                      <div class="media d-flex">
                        <div class="media-body text-left">
                          <h4 class="info">AED <?php if($cbal[0]->total) echo    bcdiv($cbal[0]->total , 1, 2);else echo 0;?></h4>
                     ...
                     <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                      <div class="progress-bar bg-gradient-x-info" role="progressbar" style="width: <?php if($total[0]->total) echo ($cbal[0]->total*100)/($total[0]->total);?>%" aria-valuenow="<?php if($total[0]->total) echo ($cbal[0]->total*100)/($total[0]->total);?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card pull-up">
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-left">
                        <h4 class="info">AED <?php if ($usedbal[0]->total) echo bcdiv($usedbal[0]->total , 1, 2); else echo 0;?></h4>
                        <h6>Total Used </h6>
                      </div>
                      <div>
                    ...
                    <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                      <div class="progress-bar bg-gradient-x-info" role="progressbar" style="width: <?php if($total[0]->total)  echo ($usedbal[0]->total*100)/($total[0]->total);?>%" aria-valuenow="<?php if($total[0]->total)  echo ($usedbal[0]->total*100)/($total[0]->total);?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card pull-up">
                <div class="card-content">
                  <div class="card-body">
                    <div class="media d-flex">
                      <div class="media-body text-left">
                        <h4 class="info">AED <?php if($refundbal[0]->total) echo    bcdiv($refundbal[0]->total , 1, 2);  else echo 0;?></h4>
                   ...
                   <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                    <div class="progress-bar bg-gradient-x-info" role="progressbar" style="width: <?php if($total[0]->total)  echo ($refundbal[0]->total*100)/($total[0]->total);?>%" aria-valuenow="<?php if($total[0]->total)  echo ($refundbal[0]->total*100)/($total[0]->total);?>" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
            </div>
...
$timestamp2 = strtotime($date2);
   $diff =round( abs($timestamp2 - $timestamp1)/(60*60) );
                   ...
                   if($v->status=="Active" && $v->type=="credited_from_order_cancel" && $diff <= 24){
                       ?>
                        <td class="py-3"><a  class="btn btn-primary cust-btn" href="<?php echo base_url();?>/profile/refundWallet/<?php echo $v->order_id;?>">Refund</td>
                    </tr>
                       <?php
                   }else{?>
