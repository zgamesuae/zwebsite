                ...
                <?php if($max_qty_err):?>
                    <div class="m-0" data-class="btn-close">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>Warning!</strong> <?php  echo $max_qty_err;?>
                        </div>
                    </div>
                <?php endif; ?>
                <h3 class="cart-title font-weight-bold">Basket&nbsp;<span>(<?php if($cart) echo  count($cart);else echo 0;?>)</span></h3>
            </div>
        </div>  
                                                     ...
                                                     <div class="product_box shadow-none bg-white rounded overflow-hidden">
                                                      <a  href="<?php echo base_url();?>/product/<?php echo $ppv->product_id;?>">
                                                        <div class="product_box_image">
                                                            <img src="<?php echo base_url();?>/assets/uploads/<?php if($pack_product_image[0]->image) echo $pack_product_image[0]->image;else echo 'noimg.png';?>" class="border-0 pack-img"  >
                                                        </div>
                                                    </a> 
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="product-image col">
                                    <a class="item-image" href="<?php echo base_url();?>/product/<?php echo $v->product_id;?>">
                                        <img  src="<?php echo base_url();?>/assets/uploads/<?php if($product_image[0]->image) echo $product_image[0]->image;else echo 'noimg.png';?>" alt="<?php echo $v->name;?>">
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="row justify-content-between pl-3 pr-3">
                                        <div class="title_productrs">
                                            <a href="<?php echo base_url();?>/product/<?php echo $v->product_id;?>"><?php echo substr($v->name,0,55);?><?php if(strlen($v->name)>55) echo '...';?></a>
                                            <div class="item-price"><span class="price">
                                                <?php 
                                                $gw_price=0;
                                                if($gid=$v->gw){
                                            ...
                                            if($v->dp > 0 ){
                                                ...
                                                $temp=(round(($v->price - ($v->dp*$v->price)/100))    ) *$v->quantity;
                                                ?>
                                                <?php echo round(bcdiv($v->price - ($v->dp*$v->price)/100, 1, 2));?>
                                                <span class="curreny">AED</span>
                                                <del class="text-gray"><?php echo bcdiv($v->price, 1, 2);?> AED</del>
                                            <?php } else {
                                                                // $ptotal=($v->price+$v->app+$gw_price)*$v->quantity;
                                                $temp=($v->price)*$v->quantity;
                                                ?>
                                            ...
                                            <div class="data-left item-data d-flex justify-content-between align-items-center">
                                                <div class="dropdown-custom">
                                                    <div class="btn-group">
                                                                                    ...
                                                                                    <?php
                                                                                     if($v->dp == 100 ) {echo 'Freebie Product';}else{
                                                                        ...
                                                                        <?php if($v->available_stock < $v->quantity){ $inStock=0;
                                                                        ?>
                                                                ...
                                                                <div class="total-price total-price font-weight-bold"><?php echo bcdiv($temp, 1, 2);?> AED</div>
                                                            </div>
                                                            <div class="specification d-flex justify-content-between">
                                                                 <?php 
                                                                if(@$age[0]){?>
                   ...
                   <?php if($cart ){?>
                    <div class="card">
                        <div class="card-body">
                            ...
                            if($v->dp > 0 ){
                                $ptotal=(round(($v->price - ( $v->dp * $v->price )/100))  + $v->app + $gw_price ) *$v->quantity;
                                $temp=(round(($v->price - ($v->dp * $v->price)/100))    ) *$v->quantity;
                                ?>
                            <?php } else {
                                $ptotal=($v->price+$v->app+$gw_price)*$v->quantity;
                            ...
                            <div class="price-summary-outer">
                                <div class="justify-content-between text-discount row">
                                    ...
                                    <div class="col-auto">
                                        <?php 
                                        if($v->dp > 0 ){
                                            echo round(bcdiv(($v->price - ($v->dp*$v->price)/100)*$v->quantity, 1, 2));
                                        } else {
