...
<?php include 'Common/Breadcrumb.php';?>
  <div class="container pb-5 mb-2 mb-md-4  pt-5">
      ...
      <div class="d-flex justify-content-between align-items-center pt-3 pb-4 pb-sm-5 mt-1">
        <h1 class="h3 mb-0">Wishlist </h1><a class="btn btn-primary text-white ps-2" href="<?php echo base_url();?>/product-list"><i class="ci-arrow-left me-2"></i>Continue shopping</a>
      </div>
      <!-- Item-->
            <!-- Item-->
      ...
      <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom products_card_box">
        <div class="d-block d-sm-flex align-items-center  text-sm-start">
            <a class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html">
                <img src="<?php echo base_url();?>/assets/uploads/<?php if($product_image[0]->image) echo $product_image[0]->image;else echo 'noimg.png';?>" class="products_cart_image" alt="Product"></a>
          <div class="pt-2">
            <h5 class="product-title fs-base mb-2"><a href="shop-single-v1.html"><?php echo $v->name;?> </a></h5>
 
            <div class="fs-sm"><span class="text-muted me-2">Brand : </span><?php echo @$brands[0]->title;?></div>
              <div class="fs-sm"><span class="text-muted me-2">Suitable For : </span><?php echo @$suitable_for[0]->title;?></div>
              
              <div class="fs-sm"><span class="text-muted me-2">Age : </span> <?php echo @$age[0]->title;?></div>
            ...
            <div class="fs-lg text-accent pt-2">
             ...
             <?php 
              if(@$v->discount_percentage > 0){
                ?>
                <?php echo number_format(@$v->price-(@$v->price*@$v->discount_percentage)/100);?> AED 
               <del><?php echo number_format(@$v->price);?> AED</del> 
                <?php
              }else{
                ?>
               <?php echo number_format(@$v->price);?> AED 
                <?php
              }
              ?>
        ...
        <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0  text-sm-start" style="max-width: 17rem;">
            
         <form method="post">
             <input type="hidden" name="id" value="<?php echo $v->id;?>">
           <button class="btn btn-primary w-100" type="submit"><span class="fs-sm">Remove</span></button>
        </form>
        	...
        	<div class="quantitynumber">
        		...
        		</span><input class="form-control" name="quantity" type="number" value="1" required min="1">
        		<span class="plus">
					...
					<button type="submit" class="btn btn-primary w-100 add_to_card_wishlist_button "><?php if($v->pre_order_enabled=="Yes") echo 'Pre Order';else echo 'Add To Cart';?></button>
