...
?>
                                    <div class="title_heading d-flex justify-content-between">
                                        ...
                                        <a href="javascript:void();" data-toggle="modal"
                                            data-target="#changeAddressModla" class="text-primary">Change</a>
                                    </div>
                                    <div class="row">
                                        <div class="col">
        ...
        {
?>
                                    <h5 class="pb-3 border-bottom text-capitalize"><strong>Delivery Address</strong>
                                    </h5>
                                    <div class="row">
                                        <div class="col-md-12 mt-2">
                                            <label class="m-0 font-weight-bold">Name </label>
                                            <input type="text" class="w-100 border border-weight-2 rounded p-2"
                                        ...
                                        <div class="col-md-12 mt-2">
                                            ...
                                            <input type="text" class="w-100 border border-weight-2 rounded p-2"
                                                ...
                                                value="<?php echo $userDetails[0]->street; ?>">
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <label class="m-0 font-weight-bold">Apartment/House No.</label>
                                            <input type="text" class="w-100 border border-weight-2 rounded p-2"
                                                placeholder="Apartment/House No." name="apartment_house" required
                                                value="<?php echo $userDetails[0]->apartment_house; ?>">
                                        </div>
                                        <div class="col-md-12 mt-2">
                                            <label class="m-0 font-weight-bold">Address</label>
                                            <input type="text" class="w-100 border border-weight-2 rounded p-2"
                                                placeholder="Address" name="address" required
                                                value="<?php echo $userDetails[0]->address; ?>">
                                        </div>
...
?>
                                                ...
                                                <option <?php if ($v->city_id == $userDetails[0]->city) echo "selected"; ?>
                                                    value="<?php echo $v->city_id; ?>"><?php echo $v->title; ?></option>
                                                <?php
                }
            } ?>
                                        ...
                                        <div class="tab-content p-4">
                                            <div class="tab-pane active" id="login_tab2">
                                                ...
                                                <div class="mt-3 headding text-center text-capitalize">
                                                    <h6 class="font-weight-bold" id="LoginUsingEmial2">-- Login using
                                                        email --</h6>
                                                </div>
                                                <form id="buyer_login_form2" class="row  " method="POST"
                                                    action="<?php echo base_url(); ?>/auth/LoginValidation"
                                                    autocomplete="off">
                                                    <div class="col-md-12 mt-2">
                                                ...
                                                <form id="ForgotForm2" class="row  " method="POST"
                                                    action="<?php echo base_url(); ?>/auth/forgotPassword"
                                                    autocomplete="off">
                                                    <div class="col-md-12 mt-2">
                                                ...
                                                <form id="verifyOTP2" method="POST"
                                                    action="<?php echo base_url(); ?>/auth/verifyOTP" autocomplete="off">

                                                    <input type="hidden" name="phone" id="vphone2" required>

                                                    <div
                                                        class="mt-3 d-flex justify-content-between border border-weight-2 rounded position-relative">

                                                        <label class="label_top m-0" style="left: 10px;">Enter
                                                            Verification code</label>
                                                        <input style="padding-left:20px !important;" min="4" max="4"
                                                            ...
                                                            class=" w-100 border-0  p-2" placeholder="XXXX">
                                                        <button
                                                            class=" w-100 btn btn-primary text-capitalize p-2">Submit</button>
                                                    </div>
                                                </form>
                                                ...
                                                <form id="loginWithOTP" method="POST"
                                                    action="<?php echo base_url(); ?>/auth/loginWithOTP"
                                                    autocomplete="off">
                                                    ...
                                                    <div
                                                        ...
                                                        <select required="" name="country_code"
                                                            class=" border-0 w-100 p-2" style="width: 82px !important">
                                                        ...
                                                        <input id="pn"
                                                            ...
                                                            class=" w-100 border-0  p-2" placeholder="50 XXX XXXX">
                                                        <button
                                                            class="w-100 btn btn-primary text-capitalize p-2">Submit</button>
                                                    </div>
                                                </form>
                                                ...
                                                <hr>
                                                <div
                                                    class="d-flex text-capitalize justify-content-between font-weight-bold">
                                                    <a href="javascript:void(0);" class="text-primary"
                                                        onclick="forgotPassword2();">Forgot Password?</a>
                                                    <a href="javascript:void(0);" class="text-primary"
                                                        onclick="document.getElementById('signupTab2').click()">Create
                                                        an Account</a>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="ergsiter_fisrt2">
                                                ...
                                                <form id="buyer_signup_form2" class="row  " method="POST"
                                                    action="<?php echo base_url(); ?>/auth/registration"
                                                    autocomplete="off">
                                            ...
                                            <div class="tab-pane" id="guest_user2">
                                                ...
                                                <form id="buyer_signup_formGuest" class="row  " method="POST"
                                                    action="<?php echo base_url(); ?>/auth/registrationGuest"
                                                    autocomplete="off">
                                                ...
                                                <form class="row">
                                                    <div class="col-12 mt-2">
                                                        <a onclick="document.getElementById('loginTab2').click()"
                                                            href="javascript:Void(0);"
                                                            class="btn btn-primary w-100 p-2 text-capitalize">login</a>
                                                    </div>
                                                </form>
                                            </div>
                                            <?php endif;?>
...
?>
                                    <div class="row">
                                        <div class="col-12 mt-2">
                                            <h5 class="pb-3 border-bottom text-capitalize"><strong>Payment method
                                                </strong></h5>
                                        </div>
                                        <div class="col-12">
                                                ...
                                                <div class=" title_productrs">
                                                    <div class="product-option-message">
                                                        <div class="m-0 product-option-message border-0">
                                                            <label class="checkbox light-green d-flex "
                                                                for="installation-checkbox">
                                                                <input id="installation-checkbox" type="radio"
                                                                    name="payment_method" value="Online payment">
                                                                <!-- <span class="checkmark" style="background-image:url(<?php echo base_url(); ?>/assets/img/credit_car.PNG)"></span>-->
                                                                <span class="checklabel ml-3 option-installation">Pay by
...
?>
                                                <div class=" title_productrs">
                                                    <div class="product-option-message">
                                                        <div class="m-0 product-option-message border-0">
                                                            <label class="checkbox light-green d-flex "
                                                                for="installation-checkbox2">
                                                                <input id="installation-checkbox2" type="radio"
                                                                    class="mr-2" name="payment_method"
                                                                    value="Cash on devlivery">
                                                                <span class="checklabel option-installation">Cash on
                                                                    Delivery</span>
                                                            </label>
                                                        </div>
                                                    </div>
...
?>
                                                ...
                                                <div class="col-12 mt-2">
                                                    <label class="m-0 font-weight-bold text-black">
                                                        <input type="checkbox" id="wallet_use" name="wallet_use"
                                                            value="Yes">
                                                        Use my wallet (<b class="black">Available balance :
                                                            <?php echo bcdiv($cbal[0]->total, 1, 2); ?> AED</b>)</label>
                                                </div>

                                                <input type="hidden" id="wallet_bal"
                                                    value="<?php echo bcdiv($cbal[0]->total, 1, 2); ?> ">
                ...
                <div class="card">
                    <div class="card-body ">
                        ...
                        <?php 
                            ...
                            $coupon_has_category=$coupon_entity[0]->on_category !==null && $coupon_entity[0]->on_category !==null;

                            $brand_condition=in_array($coupon_entity[0]->on_brand,$cart_product_brands);
                            $category_condition=in_array($coupon_entity[0]->on_category,$cart_product_categories);
...
?>
            ...
            else
            {
                ...
                { 
                    ...
                    $coupon_has_brand=$coupon_entity[0]->on_brand > 0 && $coupon_entity[0]->on_brand !== null;
                    $coupon_has_category=$coupon_entity[0]->on_category > 0 && $coupon_entity[0]->on_category !== null;
                    $_brand_condition=$coupon_entity[0]->on_brand == $v->brand;
                    $has_category_condition=$coupon_entity[0]->on_category == $v->category;
