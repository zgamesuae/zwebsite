            ...
            <div class="owl-carousel owl-theme slider_center_four_items_s">
                <div class="item">
                    <div class="category_new_home_page_Design ">
                        ...
                        <a href="https://zamzamgames.com/product-list?genre=2">
                            <img src="https://zamzamgames.com/assets/uploads/Shooter.png" alt="">
                            <img src="https://zamzamgames.com/assets/uploads/Shooter-8dc85.jpg" alt="" class="mobile_image" style="display: none;">
                            <div class="box_overlay_content">
                            <!-- <img src="https://zamzamgames.com/assets/uploads/box2.svg" alt="">-->
      ...
      <div class="row">
        <div class="col-12">
          <div class="heading heading_design_2 text-dark " >
            <h2 class="text-dark">Trending Now</h2>
          </div>
        </div>
					...
					if($v->discount_percentage > 0 ){
						...
						<div class="pricing-card">
							<div class="card-subtitle">
								<span><?php echo number_format($v->price);?><span> AED </span>
							</span>
						</div>
...
<?php if($offer_products){?>
    <div class="container-fluid  pt-3 best_offers_parent_con">
      <div class="row">
        <div class="col-12">
          <div class="heading heading_design_2 text-dark " >
            <h2 class="text-dark">Electric Scooters</h2>
        </div>
        </div>
        <div class="col-12 mt-3 overflow-hidden ">
          <div class="owl-carousel owl-theme category_list_home_page  ">
...
<?php if($offer_products){?>
    <div class="container-fluid  pt-3 best_offers_parent_con">
      <div class="row">
        <div class="col-12">
          <div class="heading heading_design_2 text-dark " >
            <h2 class="text-dark">Best In e-bikes</h2>
          </div>
        </div>
        <div class="col-12 mt-3 overflow-hidden ">
          <div class="owl-carousel owl-theme category_list_home_page  ">
