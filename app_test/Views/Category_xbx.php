...
<div class="container-fluid home-sec">
    <div class="row justify-content-center">
        <div class="sec_title col-12 col-lg-10"><h2><?php echo lg_get_text("lg_27") ?></h2></div>
        <div class="categories col-12 col-lg-10 cat d-flex-row">
            <div class="category c-xbx d-flex-column">
                <a class="j-c-center d-flex-column" href="<?php echo base_url()?>/xbox/games">
                    <div class="overlay_title"><h3><?php echo lg_get_text("lg_28") ?></h3></div>
                    <img src="<?php echo base_url()?>/assets/uploads/cat_page_games_xbx.png" alt="Xbox Games">
                </a>
            </div>
            <div class="category c-xbx d-flex-column">
                <a class="j-c-center d-flex-column" href="<?php echo base_url()?>/xbox/console">
                    <div class="overlay_title"><h3><?php echo lg_get_text("lg_29") ?></h3></div>
                    <img src="<?php echo base_url()?>/assets/uploads/cat_page_consoles_xbx.png" alt="Xbox consoles">
                </a>
            </div>
            <div class="category c-xbx d-flex-column">
                <a class="j-c-center d-flex-column" href="<?php echo base_url()?>/xbox/accessories">
                    <div class="overlay_title"><h3><?php echo lg_get_text("lg_100") ?></h3></div>
                    <img src="<?php echo base_url()?>/assets/uploads/cat_page_accessories_xbx.png" alt="Xbox accessories">
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="owl-carousel owl-theme catpage_price_slider">
                <div class="item d-flex-column j-c-center" >
                    <div class="shop_by_price_card xbx d-flex-column">
                        <a href="<?php echo base_url() ?>/product-list?category=xbox-1634548911&priceupto=35">
                            <div class="c-s-price">
                ...
                <div class="item d-flex-column j-c-center" >
                    <div class="shop_by_price_card xbx d-flex-column">
                        <a href="<?php echo base_url() ?>/product-list?category=xbox-1634548911&priceupto=50">
                            <div class="c-s-price">
                ...
                <div class="item d-flex-column j-c-center" >
                    <div class="shop_by_price_card xbx d-flex-column">
                        <a href="<?php echo base_url() ?>/product-list?category=xbox-1634548911&priceupto=75">
                            <div class="c-s-price">
                ...
                <div class="item d-flex-column j-c-center" >
                    <div class="shop_by_price_card xbx d-flex-column">
                        <a href="<?php echo base_url() ?>/product-list?category=xbox-1634548911&priceupto=150">
                            <div class="c-s-price">
                ...
                <div class="item d-flex-column j-c-center" >
                    <div class="shop_by_price_card xbx d-flex-column">
                        <a href="<?php echo base_url() ?>/product-list?category=xbox-1634548911&priceupto=200">
                            <div class="c-s-price">
...
<!-- Controllers best sellers -->
<?php
    if($controllers_best_seller)
    echo view("Product_carousel" , (array)$controllers_best_seller);
?>
