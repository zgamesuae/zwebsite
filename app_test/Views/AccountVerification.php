...
<tbody>
 <tr>
  ...
  Please verify your <?php echo $settings->business_name; ?> account.
  </p>
    ...
    To verify your account click on the button below
              ...
              <tbody>
               <tr>
                ...
                text-align: center;">
            <a target="_blank"  style="background-color: #243d97;
                border-radius: 8px;
                ...
                font-size: 20px;
                text-align: center;
                font-family: arial;" href="<?php echo base_url();?>/verify/<?php echo @$token;?>">Verify</a>
