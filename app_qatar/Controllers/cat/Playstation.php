...
class Playstation extends \App\Controllers\BaseController{
    ...
    public function index(){
		...
		$data["rpg_games"] = array("list"=>$products["product"],"title"=>strtoupper(lg_get_text("lg_97")),"link"=> base_url()."/product-list?category=playstation-1634548926&genre=4&type=5");
        ...
        $ps_exclusive_filter = [
            "master_category" => "playstation-exclusive-1699516597",
            "sort" => "Newest", // Newest, Oldest, Highest, Lowest
            "page" => 1,
            "limit" => 24,
        ];
        ...
        if($skins = $this->productModel->product_filter_query($skins_filter))
