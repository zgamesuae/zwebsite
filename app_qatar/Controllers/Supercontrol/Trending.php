...
class Trending extends \App\Controllers\BaseController
{
    public function index()
    {
        ...
        $crud->setTable("trending_products");
        $crud->setSubject("Trending products", "Trending products");
        
        // $crud->setFieldUpload('image', 'assets/uploads', base_url() . '/assets/uploads');
        $crud->unsetFields(["created_at", "updated_at"]);
        $crud->requiredFields(["product", "status", "start_date", "end_date"]);
