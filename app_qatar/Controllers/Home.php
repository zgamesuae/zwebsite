...
class Home extends BaseController {
	...
	private function home_products_carousel(){
		...
		$data["new_arrivals_accessories"] = array("list"=>$new_arrivals_accessories["product"],"title"=>strtoupper(lg_get_text("lg_23")),"link"=> base_url()."/product-list?new_realesed=Yes&type=7,55,63,27,62,37,26,29,61,31,28,30,49,64,34,57");
		...
		$data["pc_parts"] = array("list"=>$pcparts_products["product"],"title"=>strtoupper("PC PARTS"),"link"=> base_url()."/product-list?&categoryList=motherboard-1691751115,power-supply-1668593980,graphics-card-1660652597,processor-1697895866,internal-data-storage-1660738636,");
		...
		$data["racing_corner"] = array("list"=>$products["product"],"title"=>strtoupper("RACING CORNER"),"link"=> base_url()."/special-racing");
		...
		$data["new_in_collectibles"] = array("list"=>$products["product"],"title"=>strtoupper("New in Collectibles"),"link"=> base_url()."/gaming-merchandise/figurines-&-collectible?new_realesed=Yes");
		...
		$data["bundle_offers"] = array("list"=>$products["product"],"title"=>strtoupper("Bundle offers"),"link"=> base_url()."/product-list?type=12");
