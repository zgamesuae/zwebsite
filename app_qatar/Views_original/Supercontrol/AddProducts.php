                            ...
                            <div class="card-body">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="product_id"
                                        value="<?php echo @$editcat[0]->product_id ?>">
                                    <?php } ?>
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        ...
                                        <div role="tabpanel" class="tab-pane   <?php if (count(@$uri->getSegments()) < 5) { echo 'active'; } ?>" role="tabpanel" aria-labelledby="link-tab" aria-expanded="false" id="BasicInfo">
                                            ...
                                            <div class="form-group j-c-end row" id="bundle_opt_sec" style="display:<?php if($editcat[0]->bundle_opt_enabled == "Yes") echo("flex"); else echo("none"); ?>">
                                                <?php 
                                                    $options= $userModel->customQuery("select * from bundle_opt where product_id='".$editcat[0]->product_id."'");
                                                    if($options !== null):
                                                ?>
                                                    <label for="input-1" class="col-sm-3 col-form-label">Bundle options*</label>
                                                            
                                                    <div class="col-sm-9 d-flex j-c-start a-c-center add_opt_container mb-1">
                                                            
                                                        <!-- name of additional opt -->
                                                        <input class="col-6" type="text" required class="form-control" placeholder="Option name" name="bundle_opt[]" value="<?php if(isset($options[0]->option_title)) echo $options[0]->option_title;?>">

                                                        <!-- put price -->
                                                        <div class="col-lg-3 col-sm-12  mx-2 p-0">
                                                            <input type="number" placeholder="Additional Price" name="additional_price[]" class="form-control" value="<?php if(isset($options[0]->additional_price)) echo $options[0]->additional_price; ?>">
                                                        </div>
                                                            
                                                        <div class="row col-lg-1 j-c-center a-a-center p add_opt rounded"> 
                                                    ...
                                                    <div class="col-sm-9 d-flex j-c-start a-c-center add_opt_container mb-1">
                                                        ...
                                                        <!-- name of additional opt -->
                                                        <input class="col-6" type="text" required class="form-control" placeholder="Option name" name="bundle_opt[]" value="<?php if(isset($options[1]->option_title)) echo $options[1]->option_title;?>">
                                                    
                                                        <!-- put price -->
                                                        <div class="col-lg-3 col-sm-12  mx-2 p-0">
                                                            <input type="number" placeholder="Additional Price" name="additional_price[]" class="form-control" value="<?php if(isset($options[1]->additional_price)) echo $options[1]->additional_price; ?>">
                                                        </div>
                                                    
                                                    </div>

                                                <?php for($i=2 ; $i<sizeof($options) ; $i++): ?>
                                                
                                                    <div class="col-sm-9 d-flex j-c-start a-c-center add_opt_container mb-1">

                                                        <!-- name of additional opt -->
                                                        <input class="col-6" type="text" required class="form-control" placeholder="Option name" name="bundle_opt[]" value="<?php echo $options[$i]->option_title;?>">

                                                        <!-- put price -->
                                                        <div class="col-lg-3 col-sm-12  mx-2 p-0">
                                                            <input type="number" placeholder="Additional Price" name="additional_price[]" class="form-control" value="<?php echo $options[$i]->additional_price; ?>">
                                                        </div>
                                                        <!-- Delete option -->
                                                        <div class="row col-lg-1 j-c-center a-a-center p remove_opt"> 
                                                        <i style="font-size: 32px; height;auto;" class="fa-solid fa-minus"></i>
                                                    </div>
                                                ...
                                                <?php endfor;else: ?>
                                                    ...
                                                    <div class="col-sm-9 d-flex j-c-start a-c-center add_opt_container mb-1">
                                                        ...
                                                        <!-- name of additional opt -->
                                                        <input class="col-6 form-control" type="text" placeholder="Option name" name="bundle_opt[]" value="">

                                                        <!-- put price -->
                                                        <div class="col-lg-3 col-sm-12  mx-2 p-0">
                                                            <input type="number" placeholder="Additional Price" name="additional_price[]" class="form-control" value="">
                                                        </div>
                                                            
                                                        <div class="row col-lg-1 j-c-center a-a-center p add_opt"> 
                                                            <i style="font-size: 32px; height;auto;" class="fa-solid fa-plus"></i>
                                                        </div>

                                                    </div>

                                                    <div class="col-sm-9 d-flex j-c-start a-c-center add_opt_container">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 row ml-0">
                                                    <input type="number" class="form-control col-lg-3 m-0" name="discount_percentage" value="<?php echo @$editcat[0]->discount_percentage ?>" step=".01">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="show_this_product_in_home_page" required=""
                                                        ...
                                                        <option
                                                            <?php if (@$editcat[0]->status == "Yes") echo 'selected'; ?>
                                                            selected="" value="Yes">Yes</option>
                                                        <option
                                                            <?php if (@$editcat[0]->status == "No") echo 'selected'; ?>
                                                            value="No">No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="freebie" required="" class="form-control">
                                                        ...
                                                        <option
                                                            <?php if (@$editcat[0]->freebie == "Yes") echo 'selected'; ?>
                                                            selected="" value="Yes">Yes</option>
                                                        <option
                                                            <?php if (@$editcat[0]->freebie == "No") echo 'selected'; ?>
                                                            value="No">No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="evergreen" required="" class="form-control">
                                                        ...
                                                        <option
                                                            <?php if (@$editcat[0]->evergreen == "Yes") echo 'selected'; ?>
                                                            selected="" value="Yes">Yes</option>
                                                        <option
                                                            <?php if (@$editcat[0]->evergreen == "No") echo 'selected'; ?>
                                                            value="No">No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="exclusive" required="" class="form-control">
                                                        ...
                                                        <option
                                                            <?php if (@$editcat[0]->exclusive == "Yes") echo 'selected'; ?>
                                                            selected="" value="Yes">Yes</option>
                                                        <option
                                                            <?php if (@$editcat[0]->exclusive == "No") echo 'selected'; ?>
                                                            value="No">No</option>
                                                    </select>
                                                </div>
                                            </div>
