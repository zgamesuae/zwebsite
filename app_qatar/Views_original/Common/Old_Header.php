...
?>
<?php
$sql="select * from master_category where     parent_id='0' AND status='Active' order by precedence asc";
...
<!-- End Meta Pixel Code -->
  ...
  if($uri1=="product"){
   ...
   $prod=$userModel->customQuery($sql); 
   $sql="select * from product_image where     product='$uri2' and status='Active' ";
   $product_image=$userModel->customQuery($sql);   
   ?>
   <title><?php  if(@$prod[0]){ echo @$prod[0]->name;}else{ echo ucwords($settings[0]->business_name);}?></title>
   <meta name="description" content="<?php  if(@$prod[0]){ echo strip_tags(@$prod[0]->description);}else{ echo ucwords($settings[0]->business_name);}?>">
   <meta name="keywords" content="<?php  if(@$prod[0]){ echo @$prod[0]->name;}else{ echo ucwords($settings[0]->business_name);}?>" >
   <!--  Essential META Tags -->
   <meta property="og:title" content="<?php  if(@$prod[0]){ echo @$prod[0]->name;}else{ echo ucwords($settings[0]->business_name);}?>">
   <meta property="og:description" content="<?php  if(@$prod[0]){ echo strip_tags(@$prod[0]->description);}else{ echo ucwords($settings[0]->business_name);}?>">
   <meta property="og:image" content="<?php echo base_url();?>/assets/uploads/<?php if($product_image[0]->image) echo $product_image[0]->image;else echo 'noimg.png';?>">
   <meta property="og:url" content="<?php echo base_url();?>/product/<?php echo $uri2;?>">
   <meta name="twitter:card" content="<?php  if(@$prod[0]){ echo @$prod[0]->name;}else{ echo ucwords($settings[0]->business_name);}?>">
  ...
  <meta property="og:description" content="<?php  if(@$seo[0]){ echo @$seo[0]->page_description;}else{ echo ucwords($settings[0]->business_name);}?>">
  ...
  <!--  Non-Essential, But Recommended -->
  <meta property="og:site_name" content="<?php  if(@$seo[0]){ echo @$seo[0]->page_title;}else{ echo ucwords($settings[0]->business_name);}?>">
  <?php
}
?>
...
<!--<script async src="https://www.googletagmanager.com/gtag/js?id=G-9JH3PR0ZLB"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-9JH3PR0ZLB');
</script>-->
...
<meta name="p:domain_verify" content="a71ac49067cac8d86d6cde27b8dd70bc"/>
     ...
     <style>#verifyOTP{display:none}.search_box{margin-right:10px}.search_box{fill:#fff}.header_serach_parent{display:none;padding:0 10px 9px 13px;position:fixed;top:0;left:0;width:100%;z-index:9999;background:#fff}.header_serach_parent .header_serach{width:fit-content;margin-left:auto;margin-right:7px;margin-top:4px;margin-bottom:9px}form.search_box{display:flex;border:1px solid #eae8e8;border-radius:4px}form.search_box input{width:100%;border:unset}
    </style>
...
<div class="header_serach_parent">
 ...
 <div class="add_to_card_popup  show_indesktop" >
  ...
  <div class="card_pop_foot">
    ...
    <a class="btn-primary" href="<?php echo base_url();?>/checkout">checkout  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M16.172 11l-5.364-5.364 1.414-1.414L20 12l-7.778 7.778-1.414-1.414L16.172 13H4v-2z" fill="rgba(142,48,76,1)"/></svg></a>
  </div>
</div>
...
<header class="container-fluid header p-0">
      ...
      <div class="row justify-content-between">
        <div class="col-6">
          <div class="social_media">
            <ul>
              <li><a target="_blank" href="<?php echo @$settings[0]->facebook;?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 2C6.477 2 2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.989C18.343 21.129 22 16.99 22 12c0-5.523-4.477-10-10-10z"/></svg></a></li>
              <li><a target="_blank" href="<?php echo @$settings[0]->twitter;?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M22.162 5.656a8.384 8.384 0 0 1-2.402.658A4.196 4.196 0 0 0 21.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 0 0-7.126 3.814 11.874 11.874 0 0 1-8.62-4.37 4.168 4.168 0 0 0-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 0 1-1.894-.523v.052a4.185 4.185 0 0 0 3.355 4.101 4.21 4.21 0 0 1-1.89.072A4.185 4.185 0 0 0 7.97 16.65a8.394 8.394 0 0 1-6.191 1.732 11.83 11.83 0 0 0 6.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.496 8.496 0 0 0 2.087-2.165z"/></svg></a></li>
              <li><a target="_blank" href="<?php echo @$settings[0]->instagram;?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 2c2.717 0 3.056.01 4.122.06 1.065.05 1.79.217 2.428.465.66.254 1.216.598 1.772 1.153a4.908 4.908 0 0 1 1.153 1.772c.247.637.415 1.363.465 2.428.047 1.066.06 1.405.06 4.122 0 2.717-.01 3.056-.06 4.122-.05 1.065-.218 1.79-.465 2.428a4.883 4.883 0 0 1-1.153 1.772 4.915 4.915 0 0 1-1.772 1.153c-.637.247-1.363.415-2.428.465-1.066.047-1.405.06-4.122.06-2.717 0-3.056-.01-4.122-.06-1.065-.05-1.79-.218-2.428-.465a4.89 4.89 0 0 1-1.772-1.153 4.904 4.904 0 0 1-1.153-1.772c-.248-.637-.415-1.363-.465-2.428C2.013 15.056 2 14.717 2 12c0-2.717.01-3.056.06-4.122.05-1.066.217-1.79.465-2.428a4.88 4.88 0 0 1 1.153-1.772A4.897 4.897 0 0 1 5.45 2.525c.638-.248 1.362-.415 2.428-.465C8.944 2.013 9.283 2 12 2zm0 5a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm6.5-.25a1.25 1.25 0 0 0-2.5 0 1.25 1.25 0 0 0 2.5 0zM12 9a3 3 0 1 1 0 6 3 3 0 0 1 0-6z"/></svg></a></li>
  ...
  <div class="container header_middle pb-2">
    <div class="row align-items-center ">
      <div class="col-md-2  "  id="logo_headre_s">
        ...
        <div class="col-md-8" id="search_column_main">
             <div class="search_form">
              <form class="search_form_main m-0" action="<?php echo base_url();?>/product-list">
               <input type="text" class="form_control" placeholder="I'm looking for" name="keyword"  value="<?php echo @$_GET['keyword']?>" required>
            ...
            <div class="col-md-2 col-6" id="acount_menu_open_dic">
                ...
                <!-- <div class="header_top_right">
                  <div class="user_acount mr-3">
                    <div class="dropdown">
                      ...
                      <span class="caret"></span></div>
                      <ul class="dropdown-menu border-0 p-3">
                        <li class="pb-2"><a href="#">Profile</a></li>
                        <li class="pb-2"><a href="#">Change Password</a></li>
                        <li class="pb-2"><a href="#">Notification</a></li>
                      </ul>
                    </div>
                  </div>
                </div> -->
              ...
              <ul class="open_menu_mobile_s">
               ...
               if($cat2){
                foreach($cat2 as $k2=>$v2){
                 $sql="select * from master_category where     parent_id='$v2->category_id' order by precedence asc";
                 $cat3=$userModel->customQuery($sql);
                 if ($cat3) {
                   ?>
                   <li>
                    <div class="dropdown_m_menu remove_after_arrow">
                      <a href="<?php echo base_url();?>/product-list?category=<?php echo $v2->category_id;?>" class="drop_down_enable"  ><span><?php echo  $v2->category_name;?>   </span><span class="dropdown_icon"><svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M13.172 12l-4.95-4.95 1.414-1.414L16 12l-6.364 6.364-1.414-1.414z"/></svg></span></a>
                      <svg style="display: none;" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-5-9h10v2H7v-2z"/></svg>
                    </div>
                    <ul class="open_menu_mobile_s">
                      <?php 
...
/*
?>
 <li><a href="<?php echo base_url();?>/packages">Bundles</a></li>
 <?php */ } ?>
              ...
              <div class="login_mobile_button" style="display: none">
                <a href="javascript:void();" data-toggle="modal" data-target="#jagat-login-modal">login</a>
                <a  href="javascript:void();" data-toggle="modal" data-target="#jagat-login-modal">register</a>
              </div>
            </div>
    </div>
  </div>
...
<div class="modal fade" id="jagat-login-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-lg">
  ...
  <div  class="modal-body" >
      ...
      <div class="  bg-white" id="LoginDIv">
        <ul class="nav nav-tabs checkout_nav">
          ...
          <div class="tab-content p-4">
            ...
            <!--  <div class="social_media_login">
              ...
              <div class="mt-3 headding text-center text-capitalize">
                <h6 class="font-weight-bold" id="LoginUsingEmial">-- Login using email --</h6>
              </div>
          <form id="buyer_login_form" class="row  " method="POST" action="<?php echo base_url();?>/auth/LoginValidation" autocomplete="off">
                ...
                <form id="ForgotForm" class="row  " method="POST" action="<?php echo base_url();?>/auth/forgotPassword" autocomplete="off">
                  <div class="col-md-12 mt-2">
             ...
             <div id="loginWithOTPMssage"></div>
            
               <form id="verifyOTP"  method="POST" action="<?php echo base_url();?>/auth/verifyOTP" autocomplete="off">
             ...
             <form id="loginWithOTP"  method="POST" action="<?php echo base_url();?>/auth/loginWithOTP" autocomplete="off">
              ...
              <div class="d-flex text-capitalize justify-content-between font-weight-bold">
                <a href="javascript:void(0);"  class="text-primary" onclick="forgotPassword();">Forgot Password?</a>
                <a href="javascript:void(0);"  class="text-primary" onclick="document.getElementById('signupTab').click()" >Create an Account</a>
              </div>
            </div>
             ...
             <!-- <div class="headding text-center text-capitalize">
              ...
              <form id="buyer_signup_form" class="row  " method="POST" action="<?php echo base_url();?>/auth/registration" autocomplete="off">
                ...
                <div class="col-md-6 mt-2">
                  ...
                  <div class="col-md-6 mt-2">
  <label><input type="radio" name="verify_method" checked value="email"> Verify account by email </label>
</div>
        
                  <div class="col-md-6 mt-2">
               
  <label><input type="radio" name="verify_method" value="phone"> Verify account by phone </label>
    </div>  
              ...
              <div class="mt-3 headding text-center text-capitalize">
                <h6 class="font-weight-bold"> - Already Registered User?   <a href="javascript:void(0);" class="text-primary" onclick="document.getElementById('loginTab').click()"><b>Click here</b></a> to login   </h6>
              </div>
            <!--  <form class="row">
                <div class="col-12 mt-2">
              ...
              <form class="row">
                ...
                <div class="col-md-12 mt-2">
                  ...
                  <div class="d-flex justify-content-between border border-weight-2 rounded position-relative">
                      ...
                      <input type="text" class=" w-100 border-0  p-2" placeholder="50 XXX XXXX">
                    </div>
                </div>
                <div class="col-12 mt-2">
 ...
 <div class="modal-dialog modal-lg">
  ...
  <div  class="modal-body" >
    <div class="  bg-white"  >
      <ul class="nav nav-tabs checkout_nav">
        <li class="nav-item">
          <a id="loginTab" class="nav-link active" data-toggle="tab" href="#savedAddress">Saved address lists </a>
        </li>
        <li class="nav-item">
          <a  id="signupTab" class="nav-link " data-toggle="tab" href="#CrateNewAddress">Create new address</a>
        </li>
      </ul>
      <div class="tab-content p-4">
         ...
         if($user_address){
           foreach($user_address as $k=>$v ){
             ...
             <div class="col-md-6 mar-10"  >
                <a href="<?php echo base_url();?>/page/selectAddress/<?php echo $v->address_id;?>" >
              <div class="address_message myaddress_card jagat-address-list  <?php if( $v->status=='Active') echo 'active-addresss';?> ">
                ...
                <span><?php echo $v->street;?> <?php echo $v->apartment_house;?>, <?php echo $v->address;?>  </span>
        ...
        <div class="tab-pane" id="CrateNewAddress">
          ...
          <form method="post" action="<?php echo base_url();?>/page/saveAddress">
           <input class="form-control" name="address_id" type="hidden" required="" placeholder="Street" value="">
           <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                <label class="form-label" for="checkout-fn">Name</label>
                <input class="form-control" name="name" required="" type="text" placeholder="Name" value=""> 
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
                <label class="form-label" for="checkout-fn">Street</label>
                <input class="form-control" name="street" required="" type="text" placeholder="Street" value="">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
                <label class="form-label" for="checkout-fn">Apartment/House No.</label>
                <input class="form-control" name="apartment_house" required="" type="text" placeholder="Apartment/House No." value="">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
                <label class="form-label" for="checkout-fn">Address</label>
                <input class="form-control" name="address" required="" type="text" placeholder="Address" value="">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
