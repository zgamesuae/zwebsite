...
<div data-growl="container" class="alert alert-success growl-animated animated bounceInDown" role="alert"
    data-growl-position="top-right"
    style="position: fixed; margin: 0px; z-index: 1031; display: none; top: 20px; right: 20px;" id="toast">
</div>
<div data-growl="container" class="alert alert-danger growl-animated animated bounceInDown" role="alert"
    data-growl-position="top-right"
    style="position: fixed; margin: 0px; z-index: 1031; display: none; top: 20px; right: 20px;" id="toastfailure">
</div>

<!--
<div class="footer_social_contacts">
...
<footer class="container-fluid bg-light pt-3 ">
                    ...
                    <ul class="m-0 header_contact_info p-0 footer_firts_column">
                        ...
                        <li class="pb-3">
                            <a href="<?php echo base_url();?>">
                                ...
                                <span>zamzamgames.com</span>
                            </a>
                        </li>
                    </ul>
                </div>
                <!--<div class="footer_inner">
  <h5 class="text-capitalize mb-3 mt-3"><storng>Download the app</storng></h5>
  <div class="download_the_app">
    <a target="_blank" href="<?php echo @$settings[0]->android_app_link;?>">
      <img src="<?php echo base_url();?>/assets/img/playstore.png">
  </a>
  <a target="_blank" href="<?php echo @$settings[0]->ios_app_link;?>">
            ...
            <div class="col-md-3 col-sm-6 mt-4">
                <div class="footer_inner">
                    ...
                    <ul>
                        ...
                        <li><a href="<?php echo base_url();?>/page/ourstores">Our stores</a></li>
  ...
  if($master_category){
    foreach ($master_category as $key => $value) {?>
                        <li><a
                                href="<?php echo base_url();?>/product-list?category=<?php echo $value->category_id;?>"><?php echo $value->category_name;?></a>
                        </li>
                        <?php }} ?>
                    </ul>
                </div>
    ...
    <div class="header_bottom">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h3><strong>We accept the following payment methods</strong></h3>

                <div class="footer_payment_logo">
                    <img src="<?php echo base_url();?>/assets/uploads/pg-min-min.png" class="" alt="VISA">
                    <img src="<?php echo base_url();?>/assets/uploads/12b7477c-529e-4e57-98aa-ea3fb4285a2d1.png">
