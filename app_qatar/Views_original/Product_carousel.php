    ...
    <div class="row j-c-center">
        <div class="col-md-12 col-sm-12 col-lg-10">
            <div class="sec_title">
                ...
                <a href="<?php echo $link?>" class="right_posiation_buttton bnt btn-primary">View All</a>
            </div>
        </div>
                    ...
                    <div class="product_box shadow-none bg-white rounded ">
                        ...
                        <a  href="<?php echo $productModel->getproduct_url($v->product_id)?>">
                            <div class="product_box_image">
                                ...
                                ?>
                                <div class="release_date py-1 d-flex-row a-c-center" style=" position: absolute;background: linear-gradient(45deg, #0e0e0e, #646464, #000000);width: 100%;bottom: 0;"><p class="mb-0" style="color: white;">Release Date: <?php echo date('d/m/Y', strtotime($v->release_date));?></p></div>
                        ...
                        <div class="product_box_content">
                            <?php $p_title=(strlen($v->name) > 50) ? substr($v->name,0,50)."..." : $v->name; ?>
                            <h5>
                          ...
                          <?php 
                            ...
                            <div class="pricing-card">
                                ...
                                <p class="offer-price card-text">
                                    <?php echo round(bcdiv($v->price - ($v->discount_percentage*$v->price)/100, 1, 2));?><span>AED</span>
                            ...
                            <form class="products_add_to_cart each_products_add_card_list buy-now-form" method="post"
				                ...
				                ?>
				                	<button class="btn btn-primary view_detail" type="button"><a href="<?php echo base_url()."/product/".$v->product_id ?>">View details</a></button>
				                <?php else:?>
