...
<!-- Product Box -->
<div class="product_box shadow-none bg-white rounded row m-0 <?php if($hr): echo "horizontal_product_box"; else: echo "d-flex flex-column justify-content-between"; endif; ?>" style="height: 100%">
    ...
    <div class="col-12 px-0 <?php if($hr) echo "col-lg-6" ?>">
        ...
        <div class="promotion_sticker right_sticker" >
            <div class="promotion_sticker_tag p-2">
    ...
    <div class="product_box_content col-12  <?php if($hr) echo "col-lg-6 d-flex flex-column justify-content-center"; ?>">
		...
		<div class="pricing-card flex-row justify-content-between align-items-end <?php if(get_cookie("language") == 'AR'): echo "text-right"; else: echo "text-left"; endif ?>">
			...
			<div class="col-auto d-flex flex-column justify-content-center align-items-end p-0 text-center">
