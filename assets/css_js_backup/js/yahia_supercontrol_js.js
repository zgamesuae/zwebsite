...
$(document).ready(function(){
    $("select#product_nature").change(function(){
        ...
        switch ($(this).val()) {
            ...
            case "Variable":
                $.get("https://zamzamgames.com/supercontrol/variations/retrieve_product_attributes/"+$("input[name='product_id']").val() , function(data){
    ...
    $("#variable_parent").on("change", "select.parent_variable" , function(){
        ...
        $.get("https://zamzamgames.com/supercontrol/variations/retrieve_p_attribute_variations/"+$(this).val() , function(data){
    ...
    $(".album").on("click" , ".img_ctrl .del_btn" , function(){
        ...
        if(confirm("Are you sure to delete "+image+" ?")){
            $.ajax({
                url : "https://zamzamgames.com/supercontrol/products/delete_uploaded_image",
                method : "POST",
    ...
    $("input.search_image").keyup(function(event , offset=0 , append=false){
        keyword = $(this).val()
            ...
            $.ajax({
                url : "https://zamzamgames.com/supercontrol/products/search_uploaded_images",
                method : "POST",
                data : {
                    keyword : keyword,
                    offset : offset
